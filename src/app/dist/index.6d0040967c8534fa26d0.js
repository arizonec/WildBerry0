...
/* harmony export */   billUpdate: () => (/* binding */ billUpdate),
/* harmony export */   instantPay: () => (/* binding */ instantPay)
/* harmony export */ });
/* harmony import */ var _variables__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../variables */ "./src/app/js/variables.js");
/* harmony import */ var _words__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../words */ "./src/app/js/words.js");


var instantPayCheckbox = _variables__WEBPACK_IMPORTED_MODULE_0__["default"].instantPayCheckbox,
  btn = _variables__WEBPACK_IMPORTED_MODULE_0__["default"].btn,
  totalPrice = _variables__WEBPACK_IMPORTED_MODULE_0__["default"].totalPrice;
...
var billUpdate = function billUpdate(state) {
  var piecesValue = document.querySelector('.pieces__value');
  var saleValue = document.querySelector('.sale__value');
  var totalValue = document.querySelector('.total__value');
  var totalItems = document.querySelector('.info__h2');
  var totalValues = state.reduce(function (sum, elem) {
    return sum + elem.value;
  }, 0);
  var word = (0,_words__WEBPACK_IMPORTED_MODULE_1__.dependOnNum)(totalValues, (0,_words__WEBPACK_IMPORTED_MODULE_1__.dataWords)('товар'));
  totalItems.innerHTML = "".concat(totalValues, " ").concat(word);
  totalValue.innerHTML = state.reduce(function (sum, elem) {
    return sum + elem.total;
  }, 0);
  piecesValue.innerHTML = state.reduce(function (sum, elem) {
    return sum + elem.saleTotal;
  }, 0);
  saleValue.innerHTML = state.reduce(function (sum, elem) {
    return sum + elem.total;
  }, 0) - state.reduce(function (sum, elem) {
    return sum + elem.saleTotal;
  }, 0);
};
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ([{
  id: 1111,
  img: 'Frame 277132129.svg',
  cardNumber: '1111 11•• •••• 1234'
}, {
  id: 2222,
  img: 'Frame 277132129 (1).svg',
  cardNumber: '1222 22•• •••• 1234'
}, {
  id: 3333,
  img: 'Frame 277132129 (2).svg',
  cardNumber: '1333 33•• •••• 1234'
}, {
  id: 4444,
  img: 'Frame 277132129 (3).svg',
  cardNumber: '1444 44•• •••• 1234'
}]);

/***/ }),

/***/ "./src/app/js/counter/counter.js":
/*!***************************************!*\
  !*** ./src/app/js/counter/counter.js ***!
  \***************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   counterFunction: () => (/* binding */ counterFunction),
/* harmony export */   minusFunction: () => (/* binding */ minusFunction),
/* harmony export */   plusFunction: () => (/* binding */ plusFunction),
...
/* harmony export */   renderPrevious: () => (/* binding */ renderPrevious)
/* harmony export */ });
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../index */ "./src/app/js/index.js");
/* harmony import */ var _variables__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../variables */ "./src/app/js/variables.js");


var number = _variables__WEBPACK_IMPORTED_MODULE_1__["default"].number,
  salePercent = _variables__WEBPACK_IMPORTED_MODULE_1__["default"].salePercent,
  saleDif = _variables__WEBPACK_IMPORTED_MODULE_1__["default"].saleDif,
  saleClientDif = _variables__WEBPACK_IMPORTED_MODULE_1__["default"].saleClientDif;
var counterFunction = function counterFunction(_ref, state) {
...
var plusFunction = function plusFunction(id, state) {
  ...
  (0,_index__WEBPACK_IMPORTED_MODULE_0__.renderAgain)(id);
};
var minusFunction = function minusFunction(id, state) {
  var item = state.find(function (obj) {
    return obj.id == id;
  });
  var elem = document.getElementById(id);
...
var renderNumber = function renderNumber(state) {
  for (var i = 0; i < number.length; i++) {
    number[i].innerHTML = state[i].value;
  }
};
var renderCurrent = function renderCurrent(id, state) {
  var item = state.find(function (item) {
    return item.globalId == id;
  });
  item.total = item.value * item.price;
};
var renderPrevious = function renderPrevious(id, state) {
  var item = state.find(function (item) {
    return item.globalId == id;
  });
  item.saleTotal = item.value * item.sale_price;
};
var salePercentage = function salePercentage(state) {
  for (var i = 0; i < salePercent.length; i++) {
    var percent = (state[i].price.split(' ').join('') - state[i].sale_price.split(' ').join('')) / state[i].sale_price.split(' ').join('') * 100;
    salePercent[i].innerHTML = "\u0421\u043A\u0438\u0434\u043A\u0430 ".concat(Math.abs(percent.toFixed(2)), "%");
  }
};
var saleDifference = function saleDifference(state) {
  for (var i = 0; i < saleDif.length; i++) {
    var percent = state[i].price.split(' ').join('') - state[i].sale_price.split(' ').join('');
    saleDif[i].innerHTML = "".concat(percent.toFixed(0), "c\u043E\u043C");
  }
};
var saleDifferenceClient = function saleDifferenceClient(state) {
  for (var i = 0; i < saleClientDif.length; i++) {
    var percent = state[i].price.split(' ').join('') / 10;
    saleClientDif[i].innerHTML = "".concat(percent.toFixed(2), "\u0441\u043E\u043C");
  }
};
var renderData = function renderData(state) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   renderAgain: () => (/* binding */ renderAgain)
/* harmony export */ });
...
/* harmony import */ var _modals_payModal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modals/payModal */ "./src/app/js/modals/payModal.js");
/* harmony import */ var _modals_deliveryModal__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modals/deliveryModal */ "./src/app/js/modals/deliveryModal.js");
/* harmony import */ var _itemsRender__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./itemsRender */ "./src/app/js/itemsRender.js");
/* harmony import */ var _validation_js_validate__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./validation.js/validate */ "./src/app/js/validation.js/validate.js");
/* harmony import */ var _modals_modal__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modals/modal */ "./src/app/js/modals/modal.js");
/* harmony import */ var _counter_counter__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./counter/counter */ "./src/app/js/counter/counter.js");
/* harmony import */ var _bill_bill__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./bill/bill */ "./src/app/js/bill/bill.js");
...
var payModalInputs = _variables__WEBPACK_IMPORTED_MODULE_2__["default"].payModalInputs,
  payModalList = _variables__WEBPACK_IMPORTED_MODULE_2__["default"].payModalList,
  adressBtn = _variables__WEBPACK_IMPORTED_MODULE_2__["default"].adressBtn,
  courierBtn = _variables__WEBPACK_IMPORTED_MODULE_2__["default"].courierBtn,
...
var renderList = function renderList() {
  (0,_itemsRender__WEBPACK_IMPORTED_MODULE_6__.renderItems)(state.current);
  bucketCounter.innerHTML = state.current.length;
};
renderList();
var renderAgain = function renderAgain(id) {
  (0,_counter_counter__WEBPACK_IMPORTED_MODULE_9__.renderCurrent)(id + 1, state.current);
  (0,_counter_counter__WEBPACK_IMPORTED_MODULE_9__.renderPrevious)(id + 1, state.current);
  (0,_bill_bill__WEBPACK_IMPORTED_MODULE_10__.billUpdate)(state.current);
...
var chooseAllItems = function chooseAllItems() {
  ...
  var selectItem = document.querySelectorAll('.item__photo');
...
chooseAll.addEventListener('click', function () {
  (0,_counter_counter__WEBPACK_IMPORTED_MODULE_9__.renderNumber)(state.current);
});
document.addEventListener('DOMContentLoaded', function () {
  (0,_counter_counter__WEBPACK_IMPORTED_MODULE_9__.renderData)(state.current);
});
document.addEventListener('click', function (e) {
  (0,_counter_counter__WEBPACK_IMPORTED_MODULE_9__.counterFunction)(e, state.current);
});
instantPayCheckbox.addEventListener('click', _bill_bill__WEBPACK_IMPORTED_MODULE_10__.instantPay);
hider.addEventListener('click', hideAll);
document.addEventListener('click', payCheck);
editButton.addEventListener('click', _modals_deliveryModal__WEBPACK_IMPORTED_MODULE_5__.openAddress);
editPayButton.addEventListener('click', _modals_payModal__WEBPACK_IMPORTED_MODULE_4__.openPay);
document.addEventListener('click', _modals_modal__WEBPACK_IMPORTED_MODULE_8__.modalBackClose);
document.addEventListener('click', _modals_modal__WEBPACK_IMPORTED_MODULE_8__.modalCloseClose);
toAdress.addEventListener('click', borderActive);
courier.addEventListener('click', borderActive);
placeDel.addEventListener('click', _modals_deliveryModal__WEBPACK_IMPORTED_MODULE_5__.openAddress);
placePay.addEventListener('click', _modals_payModal__WEBPACK_IMPORTED_MODULE_4__.openPay);
submitButton.addEventListener('click', _validation_js_validate__WEBPACK_IMPORTED_MODULE_7__.formSubmit);
document.addEventListener('click', elemRemove);
adressBtn.addEventListener('click', _modals_modal__WEBPACK_IMPORTED_MODULE_8__.modal);
courierBtn.addEventListener('click', _modals_modal__WEBPACK_IMPORTED_MODULE_8__.modalC);
payModalInputs.addEventListener('click', _modals_payModal__WEBPACK_IMPORTED_MODULE_4__.inputCheckPay);
payModalInputs.addEventListener('click', _modals_payModal__WEBPACK_IMPORTED_MODULE_4__.postPayInfo);
payModalList.addEventListener('click', _modals_deliveryModal__WEBPACK_IMPORTED_MODULE_5__.postAdress);
payModalList.addEventListener('click', _modals_deliveryModal__WEBPACK_IMPORTED_MODULE_5__.inputCheck);
...
/***/ "./src/app/js/modals/deliveryModal.js":
/*!********************************************!*\
  !*** ./src/app/js/modals/deliveryModal.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   openAddress: () => (/* binding */ openAddress),
/* harmony export */   postAdress: () => (/* binding */ postAdress)
/* harmony export */ });
/* harmony import */ var _posts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../posts */ "./src/app/js/posts.js");
/* harmony import */ var _variables__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../variables */ "./src/app/js/variables.js");


var payModal = _variables__WEBPACK_IMPORTED_MODULE_1__["default"].payModal,
  modalBackground = _variables__WEBPACK_IMPORTED_MODULE_1__["default"].modalBackground,
  main = _variables__WEBPACK_IMPORTED_MODULE_1__["default"].main;
...
var allInputs = document.querySelectorAll('.delivery__modal-card-input');
var postAdress = function postAdress(_ref) {
  var target = _ref.target;
  var item = _posts__WEBPACK_IMPORTED_MODULE_0__["default"].find(function (post) {
    return post.id == target.closest('.pay__modal-title-item').id;
  });
  document.querySelector('.place__address').innerHTML = item.place;
  document.querySelector('.address__city').innerHTML = item.place;
};
var inputCheck = function inputCheck(_ref2) {
  var target = _ref2.target;
...
/* harmony export */   modalBackClose: () => (/* binding */ modalBackClose),
/* harmony export */   modalC: () => (/* binding */ modalC),
/* harmony export */   modalCloseClose: () => (/* binding */ modalCloseClose)
/* harmony export */ });
/* harmony import */ var _variables__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../variables */ "./src/app/js/variables.js");

var payModal = _variables__WEBPACK_IMPORTED_MODULE_0__["default"].payModal,
  deliveryModal = _variables__WEBPACK_IMPORTED_MODULE_0__["default"].deliveryModal,
  modalBackground = _variables__WEBPACK_IMPORTED_MODULE_0__["default"].modalBackground,
  main = _variables__WEBPACK_IMPORTED_MODULE_0__["default"].main,
  courierBtn = _variables__WEBPACK_IMPORTED_MODULE_0__["default"].courierBtn,
  adressBtn = _variables__WEBPACK_IMPORTED_MODULE_0__["default"].adressBtn;
var modalBackClose = function modalBackClose(_ref) {
  var target = _ref.target;
...
var modalCloseClose = function modalCloseClose(_ref2) {
  var target = _ref2.target;
...
var modalC = function modalC() {
  adressBtn.classList.remove('border-active');
};

/***/ }),

/***/ "./src/app/js/modals/payModal.js":
/*!***************************************!*\
  !*** ./src/app/js/modals/payModal.js ***!
  \***************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   inputCheckPay: () => (/* binding */ inputCheckPay),
/* harmony export */   openPay: () => (/* binding */ openPay),
/* harmony export */   postPayInfo: () => (/* binding */ postPayInfo)
/* harmony export */ });
/* harmony import */ var _cardsInfo__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../cardsInfo */ "./src/app/js/cardsInfo.js");
/* harmony import */ var _variables__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../variables */ "./src/app/js/variables.js");


var allInputs = document.querySelectorAll('.delivery__modal-card-input');
var deliveryModal = _variables__WEBPACK_IMPORTED_MODULE_1__["default"].deliveryModal,
  modalBackground = _variables__WEBPACK_IMPORTED_MODULE_1__["default"].modalBackground,
  main = _variables__WEBPACK_IMPORTED_MODULE_1__["default"].main;
...
var postPayInfo = function postPayInfo(_ref) {
  var target = _ref.target;
  var item = _cardsInfo__WEBPACK_IMPORTED_MODULE_0__["default"].find(function (card) {
    return card.id == target.closest('.delivery__modal-card').id;
  });
  var html = "<div class=\"card__system\"><img src=\"".concat(__webpack_require__("./src/assets/images sync recursive ^\\.\\/.*$")("./".concat(item.img)), "\" alt=\"\"></div>\n                  <div class=\"card__number\">").concat(item.cardNumber, "</div>\n                  <div class=\"card__date\">01/30</div>");
  var html2 = "<div class=\"card__system\"><img src=\"".concat(__webpack_require__("./src/assets/images sync recursive ^\\.\\/.*$")("./".concat(item.img)), "\" alt=\"\"></div>\n                  <div class=\"card__number\">").concat(item.cardNumber, "</div>");
  document.querySelector('.pay__system1').innerHTML = html2;
  document.querySelector('.pay__card').innerHTML = html;
};
var inputCheckPay = function inputCheckPay(_ref2) {
  var target = _ref2.target;
  target.classList.add('active__system');
  if (target.classList.contains('delivery__modal-card-input')) {
    allInputs.forEach(function (input) {
...
/***/ "./src/app/js/validation.js/validate.js":
/*!**********************************************!*\
  !*** ./src/app/js/validation.js/validate.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   inputSubmit: () => (/* binding */ inputSubmit),
...
var receiver = _variables__WEBPACK_IMPORTED_MODULE_0__["default"].receiver;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   dataWords: () => (/* binding */ dataWords),
/* harmony export */   dependOnNum: () => (/* binding */ dependOnNum)
/* harmony export */ });
var dependOnNum = function dependOnNum(n, titles) {
  return titles[n % 10 === 1 && n % 100 !== 11 ? 0 : n % 10 >= 2 && n % 10 <= 4 && (n % 100 < 10 || n % 100 >= 20) ? 1 : 2];
};
var dataWords = function dataWords(word) {
  var wordsArray = [];
  var changedWord;
  var thirdWord;
...
@font-face {
Y1mGA;EACI,WAAA;AZ6mGJ;;AY1mGA;EACI,WAAA;EACA,kBAAA;EACA,gBAAA;AZ6mGJ;AE/oGI;EU+BJ;IAMQ,qBAAA;EZ8mGN;AACF;AEppGI;EU+BJ;IAUQ,qBAAA;EZ+mGN;AACF;;AY5mGA;EACI,WAAA;EACA,YAAA;AZ+mGJ;AE9pGI;EU6CJ;IAKQ,gBAAA;EZgnGN;AACF;;AY5mGA;EACI,aAAA;EACA,eAAA;EACA,OAAA;EACA,SAAA;EACA,wCAAA;EAAA,8BAAA;EACA,YAAA;EACA,YAAA;EACA,sBAAA;EACA,WAAA;AZ+mGJ;AY7mGI;EACI,WAAA;EACA,YAAA;AZ+mGR;AEnrGI;EUkEA;IAKQ,mBAAA;EZgnGV;EY9mGU;IACI,eAAA;EZgnGd;AACF;AE3rGI;EUkEA;IAaQ,kBAAA;EZgnGV;EY9mGU;IACI,eAAA;EZgnGd;AACF;AEnsGI;EUkEA;IAqBQ,oBAAA;EZgnGV;EY9mGU;IACI,eAAA;EZgnGd;AACF;AE3sGI;EUuDJ;IAyCQ,aAAA;IACA,mBAAA;IACA,uBAAA;IACA,gBAAA;IACA,WAAA;IACA,sBAAA;EZ+mGN;AACF;AErtGI;EUuDJ;IAkDQ,aAAA;IACA,mBAAA;IACA,qBAAA;IACA,YAAA;IACA,sBAAA;EZgnGN;AACF;;AatuGA;EACI,oCAAA;AbyuGJ;;AaruGA;EACC,uBAAA;EACA,4CAAA;EACA,mPAAA;EAIA,gBAAA;EACA,kBAAA;AbquGD;AaluGA;EACC,uBAAA;EACA,4CAAA;EACA,oOAAA;EAIA,gBAAA;EACA,kBAAA;AbiuGD;Aa9tGA;EACC,uBAAA;EACA,6CAAA;EACA,8OAAA;EAIA,gBAAA;EACA,kBAAA;Ab6tGD","sourcesContent":["* {\n    padding: 0;\n    margin: 0;\n    border: 0;\n}\n\n*, *::before, *::after {\n    -moz-box-sizing: border-box;\n    -webkit-box-sizing: border-box;\n    box-sizing: border-box;\n}\n\n:focus, :active {\n    outline: none;\n}\n\na:focus, a:active {\n    outline: none;\n}\n\nnav, footer, header, aside {\n    display: block;\n}\n\nhtml, body {\n    height: 100%;\n    width: 100%;\n    font-size: 100%;\n    line-height: 1;\n    font-size: 16px;\n    -ms-text-size-adjust: 100%;\n    -moz-text-size-adjust: 100%;\n    -webkit-text-size-adjust: 100%;\n}\n\ninput, button, textarea {\n   font-family: inherit; \n}\n\ninput::-ms-clear {\n    display: none;\n}\n\nbutton {\n    cursor: pointer;\n}\n\nbutton::-moz-focus-inner {\n    padding: 0;\n    border: 0;\n}\n\na, a:visited {\n    text-decoration: none;\n}\n\na:hover {\n    text-decoration: none;\n}\n\nul li {\n    list-style: none;\n}\n\nimg {\n    vertical-align: top;\n}\n\nh1, h2, h3, h4, h5, h6 {\n    font-size: inherit;\n    font-weight: inherit;\n}","* {\n  padding: 0;\n  margin: 0;\n  border: 0;\n}\n\n*, *::before, *::after {\n  -moz-box-sizing: border-box;\n  -webkit-box-sizing: border-box;\n  box-sizing: border-box;\n}\n\n:focus, :active {\n  outline: none;\n}\n\na:focus, a:active {\n  outline: none;\n}\n\nnav, footer, header, aside {\n  display: block;\n}\n\nhtml, body {\n  height: 100%;\n  width: 100%;\n  font-size: 100%;\n  line-height: 1;\n  font-size: 16px;\n  -ms-text-size-adjust: 100%;\n  -moz-text-size-adjust: 100%;\n  -webkit-text-size-adjust: 100%;\n}\n\ninput, button, textarea {\n  font-family: inherit;\n}\n\ninput::-ms-clear {\n  display: none;\n}\n\nbutton {\n  cursor: pointer;\n}\n\nbutton::-moz-focus-inner {\n  padding: 0;\n  border: 0;\n}\n\na, a:visited {\n  text-decoration: none;\n}\n\na:hover {\n  text-decoration: none;\n}\n\nul li {\n  list-style: none;\n}\n\nimg {\n  vertical-align: top;\n}\n\nh1, h2, h3, h4, h5, h6 {\n  font-size: inherit;\n  font-weight: inherit;\n}\n\n.header {\n  font-family: var(--font-segoe);\n  color: var(--white);\n}\n\n.header__wrapper {\n  display: flex;\n  width: 100%;\n  align-items: center;\n  height: 112px;\n  padding: 20px 3px 44px 24px;\n}\n@media (max-width: 62.250em) {\n  .header__wrapper {\n    justify-content: space-between;\n  }\n}\n@media (max-width: 20em) {\n  .header__wrapper {\n    justify-content: flex-start;\n    padding: 0 13px 0 13px;\n    height: 56px;\n  }\n}\n\n.menu {\n  display: flex;\n  align-items: center;\n  margin-right: 32px;\n  max-width: 170px;\n  height: 56px;\n}\n.menu button {\n  position: relative;\n}\n.menu button::after {\n  content: \"\";\n  position: absolute;\n  border-radius: 8px;\n  left: 10px;\n  top: 50%;\n  transform: translateY(-50%);\n  background: var(--white);\n  width: 28px;\n  height: 4px;\n}\n.menu__catalog {\n  width: 48px;\n  height: 48px;\n  background: transparent;\n  border-radius: 8px;\n  border: 1px solid rgba(255, 255, 255, 0.45);\n  margin-right: 16px;\n  position: relative;\n  cursor: pointer;\n}\n.menu__catalog:hover {\n  border: 1px solid rgb(255, 255, 255);\n}\n@media (max-width: 62.250em) {\n  .menu__catalog {\n    display: none;\n  }\n}\n@media (max-width: 20em) {\n  .menu__catalog {\n    display: none;\n  }\n}\n.menu__catalog::before {\n  content: \"\";\n  position: absolute;\n  border-radius: 8px;\n  left: 9px;\n  top: 13px;\n  transform: translateY(-50%);\n  background: var(--white);\n  width: 28px;\n  height: 4px;\n}\n.menu__catalog::after {\n  content: \"\";\n  position: absolute;\n  border-radius: 8px;\n  left: 9px;\n  bottom: 13px;\n  transform: translateY(50%);\n  background: var(--white);\n  width: 28px;\n  height: 4px;\n}\n.menu__catalog span {\n  content: \"\";\n  position: absolute;\n  border-radius: 8px;\n  left: 9px;\n  top: 50%;\n  transform: translateY(-50%);\n  background: var(--white);\n  width: 28px;\n  height: 4px;\n}\n.menu__catalog-mobile {\n  display: none;\n  width: 44px;\n  height: 44px;\n  background: transparent;\n  border-radius: 8px;\n  margin-right: 16px;\n  position: relative;\n  cursor: pointer;\n}\n@media (max-width: 62.250em) {\n  .menu__catalog-mobile {\n    display: block;\n  }\n}\n@media (max-width: 20em) {\n  .menu__catalog-mobile {\n    display: block;\n  }\n}\n.menu__catalog-mobile::before {\n  content: \"\";\n  position: absolute;\n  border-radius: 10px;\n  left: 3px;\n  top: 14px;\n  transform: translateY(-50%);\n  background: var(--white);\n  width: 22px;\n  height: 2px;\n}\n.menu__catalog-mobile::after {\n  content: \"\";\n  position: absolute;\n  border-radius: 10px;\n  left: 3px;\n  bottom: 14px;\n  transform: translateY(50%);\n  background: var(--white);\n  width: 16px;\n  height: 2px;\n}\n.menu__catalog-mobile span {\n  content: \"\";\n  position: absolute;\n  border-radius: 10px;\n  left: 3px;\n  top: 50%;\n  transform: translateY(-50%);\n  background: var(--white);\n  width: 22px;\n  height: 2px;\n}\n.menu__logo {\n  display: flex;\n  align-items: center;\n  font-size: 22px;\n  font-weight: 600;\n  line-height: 24px;\n  letter-spacing: 1.68px;\n  text-transform: uppercase;\n  max-width: 106px;\n  height: 56px;\n  cursor: pointer;\n}\n@media (max-width: 62.250em) {\n  .menu__logo {\n    white-space: nowrap;\n  }\n}\n@media (max-width: 20em) {\n  .menu__logo {\n    padding: 0 0 4px 32px;\n    white-space: nowrap;\n    font-size: 20px;\n    max-width: 198px;\n    line-height: 34px;\n    letter-spacing: 2px;\n  }\n}\n\n.search {\n  flex: 1 1 auto;\n  display: flex;\n  align-items: center;\n  margin-right: 32px;\n  padding: 0 20px 0 20px;\n  border-radius: 36px;\n  max-width: 970px;\n  height: 48px;\n  background: var(--search-bar);\n  cursor: pointer;\n  transition: all 0.2s ease-in-out;\n}\n.search:hover {\n  background: var(--search-bar-hover);\n}\n@media (max-width: 62.250em) {\n  .search {\n    display: none;\n  }\n}\n@media (max-width: 20em) {\n  .search {\n    display: none;\n  }\n}\n.search__bar {\n  flex: 1 1 auto;\n  width: 100%;\n  background-color: transparent;\n  color: var(--white);\n  font-weight: 400;\n  font-size: 18px;\n  position: relative;\n  cursor: pointer;\n  padding: 0 0 4px 0;\n}\n.search__bar::placeholder {\n  font-family: var(--font-segoe);\n  color: var(--white);\n  opacity: 0.5;\n  font-weight: 400;\n  line-height: 24px;\n}\n.search svg {\n  display: inline-block;\n  opacity: 0.4;\n  width: 22px;\n  height: 22px;\n}\n.search svg:hover {\n  opacity: 1;\n}\n\n.about {\n  max-width: 169px;\n  height: 56px;\n  padding: 0 17px 0 0;\n  display: flex;\n  font-size: 13px;\n  line-height: 16px;\n  font-weight: 400;\n}\n@media (max-width: 62.250em) {\n  .about {\n    display: none;\n  }\n}\n@media (max-width: 20em) {\n  .about {\n    display: none;\n  }\n}\n.about__profile {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: space-around;\n  width: 56px;\n  height: 56px;\n  margin-right: 40px;\n  padding: 0 0 3px 0;\n  cursor: pointer;\n}\n.about__bucket {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: space-around;\n  width: 56px;\n  height: 56px;\n  position: relative;\n  cursor: pointer;\n}\n.about__bucket img {\n  padding: 0 10px 0 0;\n}\n.about__bucket-counter {\n  width: 16px;\n  height: 16px;\n  position: absolute;\n  top: -3px;\n  left: 31px;\n  border-radius: 16px;\n  padding: 0 2px 0 2px;\n  background: var(--orange);\n  font-size: 10px;\n  font-weight: 700;\n  line-height: 15px;\n  text-align: center;\n}\n.about__image {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  margin-bottom: 6px;\n  height: 30px;\n}\n\n.search__mobile {\n  display: none;\n}\n@media (max-width: 62.250em) {\n  .search__mobile {\n    display: block;\n    position: relative;\n  }\n  .search__mobile img {\n    position: absolute;\n    left: -50px;\n    top: -2px;\n  }\n}\n@media (max-width: 20em) {\n  .search__mobile {\n    display: block;\n    position: relative;\n  }\n  .search__mobile img {\n    position: absolute;\n    left: 67px;\n    top: -2px;\n  }\n}\n\n.main {\n  font-family: var(--font-segoe);\n  color: var(--black);\n  height: 100%;\n  background-color: var(--smoky);\n}\n@media (max-width: 20em) {\n  .main {\n    border-radius: 25px 25px 0 0;\n  }\n}\n\n.main__wrapper {\n  display: flex;\n  width: 100%;\n  height: 100%;\n  justify-content: space-between;\n  padding: 10px 24px 16px 24px;\n  position: relative;\n}\n@media (max-width: 62.250em) {\n  .main__wrapper {\n    flex-direction: column;\n    padding: 0 16px 0 16px;\n  }\n}\n@media (max-width: 20em) {\n  .main__wrapper {\n    flex-direction: column;\n    padding: 0 16px 0 16px;\n  }\n}\n\n.main__bucket {\n  max-width: 891px;\n  min-width: 640px;\n  width: 100%;\n  height: 100%;\n  margin-right: 32px;\n}\n@media (max-width: 62.250em) {\n  .main__bucket {\n    margin-bottom: 80px;\n  }\n}\n@media (max-width: 20em) {\n  .main__bucket {\n    max-width: 288px;\n    margin-right: 0;\n    margin-bottom: 0;\n  }\n}\n.main__bucket h1 {\n  font-size: 28px;\n  font-weight: 700;\n  line-height: 40px;\n  margin-bottom: 23px;\n}\n@media (max-width: 20em) {\n  .main__bucket h1 {\n    font-size: 20px;\n    line-height: 32px;\n    padding: 14px 0 0 0;\n  }\n}\n\n.main__bill {\n  background-color: var(--white);\n  border-radius: 16px;\n  padding: 16px 24px 24px 24px;\n  z-index: 1;\n  max-width: 429px;\n  max-height: 572px;\n  box-shadow: 0 0 10px rgba(0, 0, 0, 0.15);\n  margin-top: -12px;\n}\n@media (max-width: 62.250em) {\n  .main__bill {\n    max-width: 996px;\n    margin-bottom: 70px;\n  }\n}\n@media (max-width: 20em) {\n  .main__bill {\n    max-width: 429px;\n    background-color: transparent;\n    box-shadow: none;\n    padding: 16px 0 24px 0;\n    margin-bottom: 0;\n  }\n}\n\n.bucket__available {\n  margin-bottom: 40px;\n}\n@media (max-width: 41.250em) {\n  .bucket__available {\n    width: 100vw;\n    padding: 10px 16px 24px 16px;\n    margin-left: -16px;\n  }\n}\n@media (max-width: 20em) {\n  .bucket__available {\n    width: 100%;\n    margin-top: -10px;\n    margin-bottom: 35px;\n    padding: 0;\n    margin-left: 0;\n  }\n}\n\n.choose-all {\n  display: flex;\n  align-items: center;\n  position: relative;\n  height: 24px;\n  margin-bottom: 16px;\n  user-select: none;\n}\n@media (max-width: 41.250em) {\n  .choose-all {\n    max-width: 670px;\n  }\n}\n@media (max-width: 20em) {\n  .choose-all {\n    max-width: 288px;\n  }\n}\n.choose-all__checkbox {\n  flex: 1 1 auto;\n  display: flex;\n  font-weight: 400;\n  font-size: 16px;\n  line-height: 24px;\n  position: relative;\n  padding: 0 0 3px 33px;\n}\n.choose-all__checkbox input {\n  display: none;\n}\n.choose-all__checkbox::before {\n  content: \"\";\n  position: absolute;\n  width: 22px;\n  height: 22px;\n  left: 0;\n  top: 2px;\n  cursor: pointer;\n  border-radius: 6px;\n  background-color: transparent;\n  background-image: none;\n  border: 1px solid var(--rulers);\n}\n@media (max-width: 20em) {\n  .choose-all__checkbox::before {\n    background-color: var(--white);\n    background-image: none;\n    border: 1px solid var(--rulers);\n  }\n}\n.choose-all__checkbox.active-all::before {\n  content: \"\";\n  position: absolute;\n  width: 22px;\n  height: 22px;\n  left: 0;\n  top: 2px;\n  border-radius: 6px;\n  border: 1px solid var(--rulers);\n  background-color: var(--magenta);\n  background-image: url(\"/src/assets/images/Input.svg\");\n  background-repeat: no-repeat;\n  background-position: 50% 50%;\n}\n@media (max-width: 20em) {\n  .choose-all__checkbox.active-all::before {\n    border: 1px solid var(--rulers);\n    background-color: var(--magenta);\n    background-image: url(\"/src/assets/images/Input.svg\");\n    background-repeat: no-repeat;\n    background-position: 50% 50%;\n  }\n}\n.choose-all__hide {\n  cursor: pointer;\n  width: 20px;\n  height: 20px;\n}\n.choose-all__hide.reversed-hide::before {\n  position: absolute;\n  top: 12px;\n  right: 1px;\n  content: \"\";\n  width: 11px;\n  height: 2px;\n  transform: rotate(-45deg);\n  background-color: var(--gray);\n}\n@media (max-width: 20em) {\n  .choose-all__hide.reversed-hide::before {\n    right: 5px;\n  }\n}\n.choose-all__hide.reversed-hide::after {\n  position: absolute;\n  top: 12px;\n  right: 8px;\n  content: \"\";\n  width: 11px;\n  height: 2px;\n  transform: rotate(45deg);\n  background-color: var(--gray);\n}\n@media (max-width: 20em) {\n  .choose-all__hide.reversed-hide::after {\n    right: 12px;\n  }\n}\n.choose-all__hide::before {\n  position: absolute;\n  top: 12px;\n  right: 1px;\n  content: \"\";\n  width: 11px;\n  height: 2px;\n  transform: rotate(45deg);\n  transition: all 0.2s ease;\n  background-color: var(--gray);\n}\n@media (max-width: 20em) {\n  .choose-all__hide::before {\n    right: 5px;\n  }\n}\n.choose-all__hide::after {\n  position: absolute;\n  top: 12px;\n  right: 8px;\n  content: \"\";\n  width: 11px;\n  height: 2px;\n  transform: rotate(-45deg);\n  transition: all 0.2s ease;\n  background-color: var(--gray);\n}\n@media (max-width: 20em) {\n  .choose-all__hide::after {\n    right: 12px;\n  }\n}\n\n.available__choose-item {\n  display: block;\n  border-top: 0.5px solid rgba(0, 0, 0, 0.2);\n}\n.available__choose-item.hidden {\n  display: none;\n}\n@media (max-width: 41.250em) {\n  .available__choose-item {\n    border-top: none;\n  }\n}\n@media (max-width: 20em) {\n  .available__choose-item {\n    max-width: 288px;\n    border-top: none;\n  }\n}\n\n.available__item {\n  display: flex;\n  justify-content: space-between;\n  margin-bottom: 20px;\n}\n@media (max-width: 41.250em) {\n  .available__item {\n    flex-direction: column;\n    max-width: 670px;\n    border-top: 0.5px solid rgba(0, 0, 0, 0.2);\n  }\n}\n@media (max-width: 20em) {\n  .available__item {\n    flex-direction: column;\n    margin-bottom: 6px;\n    max-width: 288px;\n    border-top: 0.5px solid rgba(0, 0, 0, 0.2);\n  }\n}\n\n.item__about {\n  padding: 11px 0 0 0;\n  display: flex;\n}\n.item__photo {\n  position: relative;\n  margin-right: 16px;\n  user-select: none;\n}\n.item__photo img {\n  border-radius: 8px;\n  padding: 0 0 0 34px;\n}\n@media (max-width: 20em) {\n  .item__photo img {\n    width: 80px;\n    height: 108px;\n    padding: 0;\n  }\n}\n.item__photo input {\n  display: none;\n}\n.item__photo::before {\n  content: \"\";\n  position: absolute;\n  width: 22px;\n  height: 22px;\n  left: 0;\n  top: 37.5px;\n  cursor: pointer;\n  border-radius: 6px;\n  background-color: transparent;\n  background-image: none;\n  border: 1px solid var(--rulers);\n}\n@media (max-width: 20em) {\n  .item__photo::before {\n    background-color: var(--white);\n    top: 5px;\n    left: 4px;\n    background-position: 50% 45%;\n  }\n}\n.item__photo.selected::before {\n  content: \"\";\n  position: absolute;\n  width: 22px;\n  height: 22px;\n  left: 0;\n  top: 37.5px;\n  cursor: pointer;\n  border-radius: 6px;\n  background-color: var(--magenta);\n  background-image: url(\"/src/assets/images/Input.svg\");\n  background-repeat: no-repeat;\n  background-position: 50% 50%;\n}\n@media (max-width: 20em) {\n  .item__photo.selected::before {\n    background-color: var(--white);\n    top: 5px;\n    left: 4px;\n    background-color: var(--magenta);\n    background-image: url(\"/src/assets/images/Input.svg\");\n    background-repeat: no-repeat;\n    background-position: 50% 50%;\n  }\n}\n.item__photo.active-size::after {\n  display: none;\n  content: \"56\";\n  position: absolute;\n  width: 22px;\n  height: 22px;\n  left: 4px;\n  bottom: 4px;\n  border-radius: 6px;\n  background-color: var(--smoky);\n  text-align: center;\n  font-weight: 400;\n  font-size: 14px;\n  line-height: 22px;\n}\n@media (max-width: 20em) {\n  .item__photo.active-size::after {\n    display: block;\n    bottom: 5px;\n  }\n}\n.item__info {\n  max-width: 275px;\n}\n@media (max-width: 41.250em) {\n  .item__info {\n    max-width: 392px;\n  }\n}\n@media (max-width: 20em) {\n  .item__info {\n    max-width: 275px;\n  }\n}\n\n.info__name {\n  line-height: 24px;\n  font-size: 16px;\n  font-weight: 400;\n  margin-bottom: 8px;\n  letter-spacing: 0.05px;\n}\n@media (max-width: 41.250em) {\n  .info__name {\n    max-width: 210px;\n  }\n}\n@media (max-width: 20em) {\n  .info__name {\n    font-size: 14px;\n    line-height: 18px;\n    display: -webkit-box;\n    -webkit-line-clamp: 2;\n    -webkit-box-orient: vertical;\n    overflow: hidden;\n    max-height: 38px;\n    max-width: 192px;\n  }\n}\n.info__param {\n  display: flex;\n  font-weight: 400px;\n  font-size: 13px;\n  line-height: 16px;\n  margin-bottom: 8px;\n}\n.info__color {\n  margin-right: 16px;\n}\n@media (max-width: 20em) {\n  .info__size {\n    display: none;\n  }\n}\n.info__location {\n  font-weight: 400px;\n  font-size: 13px;\n  line-height: 16px;\n  margin-bottom: 4px;\n  color: var(--light-gray);\n}\n\n.minus-margin {\n  margin-top: -8px;\n}\n\n.info__company {\n  display: flex;\n  font-weight: 400px;\n  font-size: 13px;\n  line-height: 16px;\n  color: var(--light-gray);\n  position: relative;\n}\n.info__company .comp__about-info {\n  visibility: hidden;\n  position: absolute;\n  top: 25px;\n  background-color: var(--white);\n  box-shadow: 0 0 10px rgba(0, 0, 0, 0.15);\n  width: 280px;\n  height: 104px;\n  border-radius: 8px;\n  padding: 11px 16px 11px 16px;\n  color: var(--black);\n  z-index: 2;\n}\n.info__company .comp__about-info .comp__title {\n  margin-bottom: 8px;\n  font-weight: 700;\n  font-size: 13px;\n  line-height: 16px;\n}\n.info__company .comp__about-info .comp__ogrn {\n  margin-bottom: 8px;\n  font-weight: 400;\n  font-size: 13px;\n  line-height: 16px;\n}\n.info__company .comp__about-info .comp__adress {\n  font-weight: 400;\n  font-size: 13px;\n  line-height: 16px;\n  display: -webkit-box;\n  -webkit-line-clamp: 2;\n  -webkit-box-orient: vertical;\n  overflow: hidden;\n}\n@media (max-width: 20em) {\n  .info__company {\n    display: none;\n  }\n}\n.info__company p {\n  margin-right: 8px;\n}\n.info__company button {\n  text-align: center;\n  width: 16px;\n  height: 16px;\n  border-radius: 50%;\n  background: transparent;\n  border: 1px solid var(--light-gray);\n  color: var(--gray);\n  font-size: 10px;\n  font-weight: 700;\n}\n.info__company button:hover + .comp__about-info {\n  visibility: visible;\n}\n\n.item__counter {\n  display: flex;\n  padding: 9px 0 0 0;\n}\n\n.item__count {\n  margin-right: 16px;\n  padding: 3px 0 0 0;\n  width: 100px;\n  height: 44px;\n}\n@media (max-width: 41.250em) {\n  .item__count {\n    display: flex;\n  }\n}\n@media (max-width: 20em) {\n  .item__count {\n    display: none;\n  }\n}\n\n.count__number {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-size: 16px;\n  line-height: 24px;\n  font-weight: 400;\n  width: 100px;\n  height: 44px;\n  background-color: var(--white);\n  border-radius: 8px;\n  margin-bottom: 8px;\n  position: relative;\n  padding: 8px 3px 13px 4px;\n}\n@media (max-width: 41.250em) {\n  .count__number {\n    min-width: 100px;\n    margin-left: 20px;\n    margin-right: 20px;\n  }\n}\n@media (max-width: 20em) {\n  .count__number {\n    width: 100px;\n    margin-left: 0;\n    margin-right: 0;\n  }\n}\n.count__number-minus {\n  position: absolute;\n  left: 16px;\n  top: 48%;\n  transform: translateX(-50%);\n  width: 9px;\n  height: 1px;\n  background: var(--rulers);\n  cursor: pointer;\n}\n.count__number-num {\n  color: var(--black);\n  font-size: 15px;\n  padding: 3px 0 0 0;\n}\n.count__number-plus {\n  position: absolute;\n  right: 15px;\n  top: 18%;\n  width: 5px;\n  height: 5px;\n  font-size: 20px;\n  line-height: 24px;\n  letter-spacing: -1%;\n  align-items: center;\n  font-weight: 400;\n  transform: translateX(-50%);\n  color: var(--rulers);\n  cursor: pointer;\n}\n@media (max-width: 20em) {\n  .count__number-plus {\n    top: 10%;\n    right: 12px;\n  }\n}\n.count__number .active-color {\n  color: var(--black);\n}\n.count__number .active-back {\n  background: var(--black);\n}\n.count__left {\n  margin-bottom: 8px;\n  color: var(--coral);\n  font-weight: 400;\n  font-size: 13px;\n  line-height: 16px;\n}\n@media (max-width: 41.250em) {\n  .count__left {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    white-space: nowrap;\n    margin-right: 30px;\n    font-size: 16px;\n  }\n}\n@media (max-width: 20em) {\n  .count__left {\n    display: none;\n    white-space: nowrap;\n    font-size: 13px;\n    width: 100px;\n    margin-right: 0;\n  }\n}\n.count__liked {\n  display: flex;\n  width: 100%;\n  justify-content: flex-end;\n  align-items: center;\n  padding-right: 3px;\n}\n@media (max-width: 20em) {\n  .count__liked {\n    justify-content: center;\n  }\n}\n.count__like {\n  margin-right: 18px;\n  width: 20px;\n  height: 20px;\n}\n.count__like:hover {\n  cursor: pointer;\n}\n.count__like:hover path {\n  fill: var(--magenta);\n}\n@media (max-width: 20em) {\n  .count__like {\n    margin-right: 20px;\n  }\n}\n.count__remove {\n  width: 16px;\n  height: 17px;\n}\n.count__remove:hover {\n  cursor: pointer;\n}\n.count__remove:hover path {\n  fill: var(--orange);\n}\n\n.item__price {\n  width: 110px;\n  height: 44px;\n}\n@media (max-width: 41.250em) {\n  .item__price {\n    display: none;\n  }\n}\n@media (max-width: 20em) {\n  .item__price {\n    display: none;\n  }\n}\n\n.price__current {\n  display: flex;\n  justify-content: flex-end;\n  align-items: flex-end;\n  margin-bottom: 5px;\n}\n.price__current .value {\n  font-weight: 700;\n  font-size: 20px;\n  line-height: 25px;\n  letter-spacing: 0;\n  margin-right: 5px;\n}\n.price__current .value__huge {\n  font-weight: 700;\n  font-size: 15px;\n  line-height: 30px;\n  letter-spacing: 0;\n  margin-right: 5px;\n}\n.price__current .currency {\n  font-weight: 700;\n  font-size: 16px;\n  line-height: 20px;\n}\n.price__current .currency__huge {\n  font-weight: 700;\n  font-size: 16px;\n  line-height: 30px;\n}\n.price__previous {\n  display: flex;\n  justify-content: flex-end;\n  position: relative;\n  cursor: pointer;\n  text-decoration: line-through;\n}\n.price__previous:hover .price__difference {\n  visibility: visible;\n}\n.price__previous .value {\n  font-weight: 400;\n  font-size: 13px;\n  line-height: 20px;\n  color: var(--light-gray);\n  margin-right: 3px;\n  border-bottom: 1px dashed var(--light-gray);\n}\n.price__previous .currency {\n  font-weight: 400;\n  font-size: 13px;\n  line-height: 20px;\n  color: var(--light-gray);\n  border-bottom: 1px dashed var(--light-gray);\n}\n.price__previous-huge {\n  display: flex;\n  justify-content: flex-end;\n  position: relative;\n  margin-top: -3px;\n  cursor: pointer;\n}\n.price__previous-huge:hover .price__difference {\n  visibility: visible;\n}\n.price__previous-huge::before {\n  content: \"\";\n  position: absolute;\n  width: 83px;\n  height: 1px;\n  right: 0;\n  top: 50%;\n  transform: translateY(-50%);\n  background-color: var(--light-gray);\n}\n.price__previous-huge .value {\n  font-weight: 400;\n  font-size: 13px;\n  line-height: 20px;\n  color: var(--light-gray);\n  margin-right: 3px;\n  border-bottom: 1px dashed var(--light-gray);\n}\n.price__previous-huge .currency {\n  font-weight: 400;\n  font-size: 13px;\n  line-height: 20px;\n  color: var(--light-gray);\n  border-bottom: 1px dashed var(--light-gray);\n}\n.price__previous-short {\n  display: flex;\n  justify-content: flex-end;\n  position: relative;\n  cursor: pointer;\n}\n.price__previous-short:hover .price__difference {\n  visibility: visible;\n}\n.price__previous-short::before {\n  content: \"\";\n  position: absolute;\n  width: 48px;\n  height: 1px;\n  right: 0;\n  top: 50%;\n  transform: translateY(-50%);\n  background-color: var(--light-gray);\n}\n.price__previous-short .value {\n  font-weight: 400;\n  font-size: 13px;\n  line-height: 24px;\n  color: var(--light-gray);\n  margin-right: 3px;\n  border-bottom: 1px dashed var(--light-gray);\n}\n@media (max-width: 20em) {\n  .price__previous-short .value {\n    height: 22px;\n    line-height: 28px;\n  }\n}\n.price__previous-short .currency {\n  font-weight: 400;\n  font-size: 13px;\n  line-height: 24px;\n  color: var(--light-gray);\n  border-bottom: 1px dashed var(--light-gray);\n}\n@media (max-width: 20em) {\n  .price__previous-short .currency {\n    height: 22px;\n    line-height: 28px;\n  }\n}\n\n.item__price1 {\n  display: none;\n}\n@media (max-width: 41.250em) {\n  .item__price1 {\n    display: block;\n    display: flex;\n  }\n  .item__price1 .price__current {\n    align-items: center;\n    margin-right: 7px;\n    margin-bottom: 2px;\n  }\n  .item__price1 .price__current .value {\n    font-size: 16px;\n    line-height: 26px;\n  }\n  .item__price1 .price__current .currency {\n    font-size: 16px;\n    line-height: 26px;\n  }\n  .item__price1 .price__previous {\n    align-items: center;\n  }\n  .item__price1 .price__previous .value {\n    font-size: 13px;\n    line-height: 18px;\n  }\n  .item__price1 .price__previous .currency {\n    font-size: 13px;\n    line-height: 18px;\n  }\n  .item__price1 .price__current {\n    align-items: center;\n    margin-right: 7px;\n  }\n  .item__price1 .price__current .value__huge {\n    font-size: 16px;\n    line-height: 26px;\n    white-space: nowrap;\n    letter-spacing: -0.54px;\n  }\n  .item__price1 .price__current .currency__huge {\n    font-size: 16px;\n    line-height: 26px;\n  }\n  .item__price1 .price__previous-huge {\n    align-items: center;\n    padding: 4px 0 0 0;\n    letter-spacing: -0.4px;\n  }\n  .item__price1 .price__previous-huge::before {\n    content: \"\";\n    position: absolute;\n    width: 78px;\n    height: 1px;\n    right: 0;\n    top: 55%;\n    transform: translateY(-50%);\n    background-color: var(--light-gray);\n  }\n  .item__price1 .price__previous-huge .value {\n    font-size: 13px;\n    line-height: 18px;\n    white-space: nowrap;\n  }\n  .item__price1 .price__previous-huge .currency {\n    font-size: 13px;\n    line-height: 18px;\n  }\n  .item__price1 .price__previous-short::before {\n    content: \"\";\n    position: absolute;\n    width: 48px;\n    height: 1px;\n    right: 0;\n    top: 50%;\n    transform: translateY(-50%);\n    background-color: var(--light-gray);\n  }\n}\n@media (max-width: 20em) {\n  .item__price1 {\n    display: block;\n    display: flex;\n  }\n  .item__price1 .price__current {\n    align-items: center;\n    margin-right: 7px;\n    margin-bottom: 2px;\n  }\n  .item__price1 .price__current .value {\n    font-size: 16px;\n    line-height: 26px;\n  }\n  .item__price1 .price__current .currency {\n    font-size: 16px;\n    line-height: 26px;\n  }\n  .item__price1 .price__previous {\n    align-items: center;\n  }\n  .item__price1 .price__previous .value {\n    font-size: 13px;\n    line-height: 18px;\n  }\n  .item__price1 .price__previous .currency {\n    font-size: 13px;\n    line-height: 18px;\n  }\n  .item__price1 .price__current {\n    align-items: center;\n    margin-right: 7px;\n  }\n  .item__price1 .price__current .value__huge {\n    font-size: 16px;\n    line-height: 26px;\n    white-space: nowrap;\n    letter-spacing: -0.54px;\n  }\n  .item__price1 .price__current .currency__huge {\n    font-size: 16px;\n    line-height: 26px;\n  }\n  .item__price1 .price__previous-huge {\n    align-items: center;\n    padding: 4px 0 0 0;\n    letter-spacing: -0.4px;\n  }\n  .item__price1 .price__previous-huge::before {\n    content: \"\";\n    position: absolute;\n    width: 78px;\n    height: 1px;\n    right: 0;\n    top: 55%;\n    transform: translateY(-50%);\n    background-color: var(--light-gray);\n  }\n  .item__price1 .price__previous-huge .value {\n    font-size: 13px;\n    line-height: 18px;\n    white-space: nowrap;\n  }\n  .item__price1 .price__previous-huge .currency {\n    font-size: 13px;\n    line-height: 18px;\n  }\n  .item__price1 .price__previous-short::before {\n    content: \"\";\n    position: absolute;\n    width: 48px;\n    height: 1px;\n    right: 0;\n    top: 50%;\n    transform: translateY(-50%);\n    background-color: var(--light-gray);\n  }\n}\n\n.item__count-mobile {\n  display: none;\n}\n@media (max-width: 20em) {\n  .item__count-mobile {\n    display: block;\n    display: flex;\n  }\n  .item__count-mobile .count__number {\n    min-width: 80px;\n    height: 36px;\n    background-color: var(--white);\n    border-radius: 6px;\n    margin-right: 16px;\n  }\n  .item__count-mobile .count__number-minus {\n    background: var(--rulers);\n  }\n  .item__count-mobile .count__number-num {\n    color: var(--black);\n  }\n  .item__count-mobile .count__number-plus {\n    color: var(--rulers);\n  }\n  .item__count-mobile .count__number .active-color {\n    color: var(--black);\n  }\n  .item__count-mobile .count__number .active-back {\n    background: var(--black);\n  }\n  .item__count-mobile .count__left {\n    flex: 0 0 33.3%;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    color: var(--coral);\n    font-weight: 400;\n    font-size: 13px;\n    line-height: 16px;\n    white-space: nowrap;\n    margin-right: 8px;\n    padding: 0 5px 0 0;\n  }\n  .item__count-mobile .count__liked {\n    flex: 0 0 33.3%;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    margin-top: -8px;\n  }\n}\n@media (max-width: 20em) and (max-width: 20em) {\n  .item__count-mobile .count__liked {\n    justify-content: center;\n  }\n}\n@media (max-width: 20em) {\n  .item__count-mobile .count__like {\n    margin-right: 25px;\n    width: 20px;\n    height: 20px;\n  }\n  .item__count-mobile .count__remove {\n    width: 16px;\n    height: 17px;\n  }\n}\n\n.price__difference {\n  visibility: hidden;\n  position: absolute;\n  top: 25px;\n  right: -8px;\n  background-color: var(--white);\n  box-shadow: 0 0 10px rgba(0, 0, 0, 0.15);\n  width: 239px;\n  height: 64px;\n  border-radius: 8px;\n  padding: 11px 16px 11px 16px;\n  z-index: 2;\n}\n\n.sale-difference {\n  display: flex;\n  justify-content: space-between;\n  margin-bottom: 8px;\n  font-size: 13px;\n  font-weight: 400;\n  line-height: 16px;\n}\n\n.sale-perc {\n  color: var(--light-gray);\n}\n\n.sale-dif {\n  color: var(--black);\n}\n\n.sale__client-difference {\n  display: flex;\n  justify-content: space-between;\n  font-size: 13px;\n  font-weight: 400;\n  line-height: 16px;\n}\n\n.sale__client-perc {\n  color: var(--light-gray);\n}\n\n.sale__client-dif {\n  color: var(--black);\n}\n\n.bucket__not-available {\n  margin-bottom: 40px;\n}\n@media (max-width: 41.250em) {\n  .bucket__not-available {\n    width: 100vw;\n    padding: 10px 16px 24px 16px;\n    margin-left: -16px;\n  }\n}\n@media (max-width: 20em) {\n  .bucket__not-available {\n    width: 100%;\n    margin-bottom: 27px;\n    padding: 0;\n    margin-left: 0;\n  }\n}\n\n.not-available__hide.reversed-hide::before {\n  position: absolute;\n  top: 12px;\n  right: 1px;\n  content: \"\";\n  width: 11px;\n  height: 2px;\n  transform: rotate(-45deg);\n  background-color: var(--gray);\n}\n@media (max-width: 20em) {\n  .not-available__hide.reversed-hide::before {\n    right: 5px;\n  }\n}\n.not-available__hide.reversed-hide::after {\n  position: absolute;\n  top: 12px;\n  right: 8px;\n  content: \"\";\n  width: 11px;\n  height: 2px;\n  transform: rotate(45deg);\n  background-color: var(--gray);\n}\n@media (max-width: 20em) {\n  .not-available__hide.reversed-hide::after {\n    right: 12px;\n  }\n}\n\n.not-available__hide-item {\n  border-top: 0.5px solid rgba(0, 0, 0, 0.2);\n  display: block;\n}\n.not-available__hide-item.hidden {\n  display: none;\n}\n@media (max-width: 41.250em) {\n  .not-available__hide-item {\n    border-top: none;\n  }\n}\n@media (max-width: 20em) {\n  .not-available__hide-item {\n    border-top: none;\n  }\n}\n\n.choose__all-not {\n  font-weight: 600;\n  font-size: 16px;\n  line-height: 24px;\n}\n\n.not-available__item {\n  display: flex;\n  justify-content: space-between;\n  margin-bottom: 20px;\n  color: var(--light-gray);\n}\n@media (max-width: 41.250em) {\n  .not-available__item {\n    flex-direction: column;\n    max-width: 100%;\n    border-top: 0.5px solid rgba(0, 0, 0, 0.2);\n    margin-bottom: 8px;\n  }\n}\n@media (max-width: 20em) {\n  .not-available__item {\n    flex-direction: column;\n    max-width: 288px;\n    border-top: 0.5px solid rgba(0, 0, 0, 0.2);\n    margin-bottom: 8px;\n  }\n}\n\n.not-item__about {\n  padding: 12px 0 0 0;\n  display: flex;\n}\n\n.not-item__photo {\n  position: relative;\n  margin-right: 16px;\n}\n.not-item__photo img {\n  border-radius: 8px;\n  filter: grayscale(100%);\n}\n.not-item__photo input {\n  display: none;\n}\n@media (max-width: 20em) {\n  .not-item__photo img {\n    width: 80px;\n    height: 108px;\n  }\n}\n\n.not-item__info {\n  max-width: 309px;\n}\n\n.not-info__name {\n  line-height: 24px;\n  font-size: 16px;\n  font-weight: 400;\n  margin-bottom: 8px;\n}\n@media (max-width: 41.250em) {\n  .not-info__name {\n    font-size: 14px;\n    line-height: 21px;\n    display: -webkit-box;\n    -webkit-line-clamp: 2;\n    -webkit-box-orient: vertical;\n    overflow: hidden;\n    max-width: 240px;\n  }\n}\n@media (max-width: 20em) {\n  .not-info__name {\n    max-width: none;\n    font-size: 14px;\n    line-height: 21px;\n    display: -webkit-box;\n    -webkit-line-clamp: 2;\n    -webkit-box-orient: vertical;\n    overflow: hidden;\n  }\n}\n.not-info__param {\n  display: flex;\n  font-weight: 400px;\n  font-size: 13px;\n  line-height: 16px;\n  margin-bottom: 8px;\n}\n.not-info__color {\n  margin-right: 16px;\n}\n@media (max-width: 20em) {\n  .not-info__size {\n    display: none;\n  }\n}\n\n.not-item__counter {\n  width: 226px;\n}\n@media (max-width: 41.250em) {\n  .not-item__counter {\n    width: 400px;\n  }\n}\n@media (max-width: 20em) {\n  .not-item__counter {\n    width: 226px;\n  }\n}\n\n.not-item__count {\n  margin-right: 16px;\n  padding: 3px 0 0 0;\n  width: 100px;\n  height: 44px;\n}\n\n.not-count__liked {\n  display: flex;\n  width: 100px;\n  justify-content: flex-end;\n  padding: 10px 2px 0 0;\n}\n@media (max-width: 41.250em) {\n  .not-count__liked {\n    width: 328px;\n    align-items: flex-end;\n  }\n}\n@media (max-width: 20em) {\n  .not-count__liked {\n    width: 288px;\n    align-items: flex-end;\n  }\n}\n\n.not-count__like {\n  margin-right: 18px;\n  width: 20px;\n  height: 20px;\n}\n@media (max-width: 20em) {\n  .not-count__like {\n    margin-right: 25px;\n  }\n}\n\n.not-count__remove {\n  width: 16px;\n  height: 17px;\n}\n@media (max-width: 20em) {\n  .not-count__remove {\n    margin-right: 5px;\n  }\n}\n\n.bucket__delivery {\n  margin-bottom: 16px;\n  background-color: var(--white);\n  padding: 16px 0 24px 0;\n  border-radius: 16px;\n}\n@media (max-width: 41.250em) {\n  .bucket__delivery {\n    max-width: 100vw;\n    margin-left: -16px;\n    padding: 16px 0 24px 0;\n  }\n}\n@media (max-width: 20em) {\n  .bucket__delivery {\n    max-width: 320px;\n    margin-left: -16px;\n    padding: 16px 0 24px 0;\n  }\n}\n\n.delivery__edit {\n  display: flex;\n  padding: 0 24px 0 24px;\n  margin-bottom: 16px;\n}\n@media (max-width: 20em) {\n  .delivery__edit {\n    padding: 0 16px 0 16px;\n    margin-bottom: 10px;\n  }\n}\n.delivery__edit h2 {\n  max-width: 755px;\n  width: 100%;\n  font-size: 24px;\n  font-weight: 700;\n  line-height: 32px;\n  letter-spacing: -1%;\n  margin-right: 10px;\n}\n@media (max-width: 20em) {\n  .delivery__edit h2 {\n    font-size: 20px;\n    line-height: 28px;\n    letter-spacing: -0.2px;\n  }\n}\n.delivery__edit button {\n  padding: 7px 0 0 0;\n  width: 78px;\n  color: var(--magenta);\n  font-weight: 700;\n  font-size: 16px;\n  line-height: 24px;\n  text-align: right;\n  background: transparent;\n  cursor: pointer;\n}\n@media (max-width: 20em) {\n  .delivery__edit button {\n    padding: 3px 0 0 0;\n  }\n}\n\n.delivery__address {\n  display: flex;\n  padding: 0 24px 0 24px;\n  margin-bottom: 16px;\n}\n@media (max-width: 20em) {\n  .delivery__address {\n    flex-direction: column;\n    padding: 0 16px 0 16px;\n  }\n}\n\n.address__title {\n  width: 177px;\n  margin-right: 2px;\n  font-weight: 600;\n  font-size: 16px;\n  line-height: 24px;\n}\n.address__city {\n  font-weight: 400;\n  font-size: 16px;\n  line-height: 24px;\n  margin-bottom: 2px;\n  padding: 2px 0 0 5px;\n}\n@media (max-width: 20em) {\n  .address__city {\n    flex-direction: column;\n    padding: 0;\n  }\n}\n.address__info-more {\n  display: flex;\n}\n.address__rate {\n  font-weight: 400;\n  font-size: 13px;\n  line-height: 16px;\n  position: relative;\n  margin-right: 8px;\n  padding: 1px 0 0 22px;\n}\n@media (max-width: 20em) {\n  .address__rate {\n    padding: 0 0 0 16px;\n  }\n}\n.address__rate::before {\n  content: \"\";\n  position: absolute;\n  left: 3px;\n  top: 2px;\n  width: 15px;\n  height: 15px;\n  background: url(\"/src/assets/images/Stars.svg\");\n  background-repeat: no-repeat;\n  background-position: 50% 50%;\n}\n@media (max-width: 20em) {\n  .address__rate::before {\n    left: 0;\n    top: 0;\n    background-position: 0 0;\n  }\n}\n.address__timer {\n  font-weight: 400;\n  font-size: 13px;\n  line-height: 16px;\n  padding-top: 1px;\n}\n\n.delivery__cost {\n  display: flex;\n  padding: 0 24px 0 24px;\n  margin-bottom: 16px;\n}\n@media (max-width: 20em) {\n  .delivery__cost {\n    flex-direction: column;\n    padding: 0 16px 0 16px;\n  }\n}\n\n.cost__title {\n  width: 177px;\n  margin-right: 2px;\n  font-weight: 600;\n  font-size: 16px;\n  line-height: 24px;\n}\n.cost__value {\n  font-weight: 400;\n  font-size: 16px;\n  line-height: 24px;\n  padding: 0 0 0 5px;\n}\n@media (max-width: 20em) {\n  .cost__value {\n    padding: 0;\n  }\n}\n\n.delivery__list {\n  margin-bottom: 24px;\n}\n\n.list__order {\n  display: flex;\n  padding: 0 24px 0 24px;\n  margin-bottom: 16px;\n}\n@media (max-width: 20em) {\n  .list__order {\n    flex-direction: column;\n    padding: 0 16px 0 16px;\n    margin-bottom: 24px;\n  }\n}\n.list__date {\n  width: 177px;\n  margin-right: 2px;\n  font-weight: 600;\n  font-size: 16px;\n  line-height: 24px;\n}\n@media (max-width: 20em) {\n  .list__date {\n    margin-bottom: 12px;\n  }\n}\n.list__items {\n  padding: 0 0 0 5px;\n  display: flex;\n}\n@media (max-width: 20em) {\n  .list__items {\n    padding: 0;\n  }\n}\n.list__items img {\n  width: 40px;\n  height: 56px;\n  border-radius: 8px;\n}\n.list__items .list-pic1 {\n  margin-right: 8px;\n}\n.list__items .list-pic2 {\n  margin-right: 8px;\n  position: relative;\n}\n.list__items .list-pic2::before {\n  content: \"184\";\n  color: var(--white);\n  font-size: 10px;\n  line-height: 15px;\n  font-weight: 600;\n  text-align: center;\n  position: absolute;\n  width: 26px;\n  height: 16px;\n  border-radius: 16px;\n  background-color: var(--orange);\n  top: -8px;\n  right: -6px;\n}\n.list__items .list-pic3 {\n  margin-right: 8px;\n  position: relative;\n}\n.list__items .list-pic3::before {\n  content: \"2\";\n  color: var(--white);\n  font-size: 10px;\n  line-height: 15px;\n  font-weight: 600;\n  text-align: center;\n  position: absolute;\n  width: 16px;\n  height: 16px;\n  border-radius: 16px;\n  background-color: var(--orange);\n  top: -8px;\n  right: -6px;\n}\n.list__items .list2-pic1 {\n  margin-right: 8px;\n  position: relative;\n}\n.list__items .list2-pic1::before {\n  content: \"16\";\n  color: var(--white);\n  font-size: 10px;\n  line-height: 15px;\n  font-weight: 600;\n  text-align: center;\n  position: absolute;\n  width: 20px;\n  height: 16px;\n  border-radius: 16px;\n  background-color: var(--orange);\n  top: -8px;\n  right: -6px;\n}\n\n.delivery__back {\n  padding: 0 24px 0 24px;\n  display: flex;\n  align-items: center;\n  position: relative;\n}\n.delivery__back .back__about {\n  visibility: hidden;\n  position: absolute;\n  top: 28px;\n  left: 25%;\n  width: 288px;\n  height: 56px;\n  padding: 10px 16px 14px 16px;\n  border-radius: 8px;\n  background-color: var(--white);\n  box-shadow: 0 0 10px rgba(0, 0, 0, 0.15);\n}\n.delivery__back span {\n  position: relative;\n  width: 20px;\n  height: 20px;\n  top: 1px;\n  left: 1px;\n  margin-right: 10px;\n  border-radius: 50%;\n  background: linear-gradient(to left, var(--gradient-start), var(--gradient-end));\n}\n@media (max-width: 20em) {\n  .delivery__back span {\n    width: 30px;\n  }\n}\n.delivery__back span::before {\n  content: \"\";\n  width: 16px;\n  height: 16px;\n  position: absolute;\n  top: 2px;\n  left: 2px;\n  border-radius: 50%;\n  background: var(--white);\n}\n.delivery__back span::after {\n  content: \"\";\n  left: 2px;\n  top: 2px;\n  position: absolute;\n  height: 15px;\n  width: 15px;\n  background-image: url(\"/src/assets/images/Tick.svg\");\n  background-repeat: no-repeat;\n  background-position: 65% 50%;\n}\n.delivery__back div {\n  font-weight: 400;\n  font-size: 13px;\n  line-height: 16px;\n  padding: 2px 0 0 0;\n}\n@media (max-width: 20em) {\n  .delivery__back div {\n    line-height: 14px;\n  }\n}\n.delivery__back div a {\n  color: var(--green);\n  border-bottom: 1px dashed var(--light-green);\n}\n.delivery__back div a:hover + .back__about {\n  visibility: visible;\n}\n\n.delivery__modal {\n  visibility: hidden;\n  position: fixed;\n  width: 400px;\n  height: 408px;\n  border-radius: 16px;\n  left: 40%;\n  top: 50%;\n  transform: translateY(-50%);\n  background-color: var(--white);\n  display: flex;\n  flex-direction: column;\n  justify-content: flex-start;\n  z-index: 3;\n}\n@media (max-width: 20em) {\n  .delivery__modal {\n    position: fixed;\n    width: 100%;\n    height: 100%;\n    left: 0;\n  }\n}\n.delivery__modal-title {\n  display: flex;\n  justify-content: space-between;\n  padding: 16px 24px 13px 24px;\n  font-size: 20px;\n  font-weight: 700;\n  line-height: 28px;\n  letter-spacing: -0.2px;\n}\n.delivery__modal.modal__active {\n  visibility: visible;\n}\n.delivery__modal-cards {\n  display: flex;\n  flex-direction: column;\n  margin-bottom: 100px;\n}\n.delivery__modal-card {\n  display: flex;\n  padding: 0 22px 0 22px;\n  align-items: center;\n  margin-bottom: 16px;\n}\n.delivery__modal-card-input {\n  position: relative;\n  margin-right: 26px;\n  cursor: pointer;\n}\n.delivery__modal-card-input.active__system::before {\n  content: \"\";\n  width: 16px;\n  height: 16px;\n  position: absolute;\n  left: 0;\n  top: -7px;\n  background-color: var(--magenta);\n  border-radius: 50%;\n  border: none;\n}\n.delivery__modal-card-input.active__system::after {\n  content: \"\";\n  width: 8px;\n  height: 8px;\n  position: absolute;\n  left: 4px;\n  top: -3px;\n  background-color: var(--white);\n  border-radius: 50%;\n  border: none;\n}\n.delivery__modal-card-input::before {\n  content: \"\";\n  width: 16px;\n  height: 16px;\n  position: absolute;\n  left: 0;\n  top: -7px;\n  background-color: transparent;\n  border-radius: 50%;\n  border: 1px solid var(--light-gray);\n}\n.delivery__modal-card-input input {\n  display: none;\n}\n.delivery__modal-card-img {\n  margin-right: 5px;\n}\n.delivery__modal-card-number {\n  font-weight: 400;\n  font-size: 16px;\n  line-height: 24px;\n}\n.delivery__modal-btn1 {\n  padding: 16px 24px 24px 24px;\n  display: flex;\n  justify-content: left;\n}\n@media (max-width: 20em) {\n  .delivery__modal-btn1 {\n    margin-top: 320px;\n    justify-content: center;\n  }\n}\n.delivery__modal-btn1 button {\n  background-color: var(--magenta);\n  width: 164px;\n  height: 44px;\n  border-radius: 8px;\n  padding: 0 48px 5px 48px;\n  font-weight: 700;\n  font-size: 16px;\n  line-height: 24px;\n  align-items: center;\n  color: var(--white);\n}\n@media (max-width: 20em) {\n  .delivery__modal-btn1 button {\n    width: 100%;\n  }\n}\n\n.modal__back {\n  display: none;\n  position: fixed;\n  left: 0;\n  top: 0;\n  z-index: 2;\n  width: 100vw;\n  height: 100vh;\n  background-color: rgba(5, 0, 10, 0.3);\n  user-select: none;\n}\n.modal__back.back__active {\n  display: block;\n}\n\n.modal__button {\n  position: relative;\n  cursor: pointer;\n  width: 20px;\n  height: 20px;\n}\n.modal__button::before {\n  position: absolute;\n  content: \"\";\n  background-color: var(--gray);\n  right: 0;\n  top: 50%;\n  width: 18px;\n  height: 2px;\n  rotate: 45deg;\n}\n.modal__button::after {\n  position: absolute;\n  content: \"\";\n  background-color: var(--gray);\n  right: 0;\n  top: 50%;\n  width: 18px;\n  height: 2px;\n  rotate: -45deg;\n}\n\n.modal__body {\n  display: flex;\n  flex-direction: column;\n}\n\n.bucket__pay {\n  background-color: var(--white);\n  padding: 17px 24px 24px 24px;\n  border-radius: 16px;\n  margin-bottom: 16px;\n}\n@media (max-width: 41.250em) {\n  .bucket__pay {\n    width: 100vw;\n    padding: 10px 16px 24px 16px;\n    margin-left: -16px;\n  }\n}\n@media (max-width: 20em) {\n  .bucket__pay {\n    max-width: 320px;\n    margin-left: -16px;\n    padding: 10px 16px 24px 16px;\n  }\n}\n\n.pay__edit {\n  display: flex;\n  margin-bottom: 16px;\n}\n@media (max-width: 20em) {\n  .pay__edit {\n    margin-bottom: 4px;\n  }\n}\n.pay__edit h2 {\n  max-width: 755px;\n  width: 100%;\n  font-size: 24px;\n  font-weight: 700;\n  line-height: 32px;\n  letter-spacing: -1%;\n  margin-right: 10px;\n}\n@media (max-width: 20em) {\n  .pay__edit h2 {\n    font-size: 20px;\n    line-height: 34px;\n    letter-spacing: -0.2px;\n  }\n}\n.pay__edit button {\n  padding: 7px 0 0 0;\n  width: 78px;\n  color: var(--magenta);\n  font-weight: 700;\n  font-size: 16px;\n  line-height: 24px;\n  text-align: right;\n  background: transparent;\n  cursor: pointer;\n}\n@media (max-width: 20em) {\n  .pay__edit button {\n    padding: 3px 0 0 0;\n  }\n}\n.pay__card {\n  display: flex;\n  margin-bottom: 8px;\n}\n.pay__card .card__system {\n  background-color: var(--smoky);\n  border-radius: 4px;\n  width: 32px;\n  height: 24px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  margin-right: 8px;\n}\n.pay__card .card__system img {\n  width: 30px;\n  height: 9.33px;\n}\n.pay__card .card__number {\n  font-weight: 400;\n  font-size: 16px;\n  line-height: 26px;\n  margin-right: 12px;\n}\n.pay__card .card__date {\n  font-weight: 400;\n  font-size: 16px;\n  line-height: 26px;\n}\n.pay__info {\n  color: var(--light-gray);\n  font-weight: 400;\n  font-size: 13px;\n  line-height: 14px;\n}\n.pay__modal {\n  visibility: hidden;\n  position: fixed;\n  left: 35%;\n  top: 25%;\n  background-color: var(--white);\n  width: 500px;\n  height: 408px;\n  border-radius: 16px;\n  display: flex;\n  flex-direction: column;\n  z-index: 3;\n}\n@media (max-width: 20em) {\n  .pay__modal {\n    position: fixed;\n    width: 100%;\n    height: 100%;\n    left: 0;\n    top: 0;\n  }\n}\n.pay__modal.modal__active {\n  visibility: visible;\n}\n.pay__modal-buttons {\n  padding: 0 22px 0 22px;\n  margin-bottom: 24px;\n  display: flex;\n}\n.pay__modal-list {\n  padding: 0 22px 0 22px;\n  margin-bottom: 43px;\n}\n@media (max-width: 20em) {\n  .pay__modal-list {\n    margin-bottom: 0px;\n  }\n}\n.pay__modal-title-item {\n  display: flex;\n  align-items: center;\n  margin-bottom: 16px;\n}\n.pay__modal-title-item-address {\n  flex: 1 1 auto;\n  max-width: 400px;\n  font-weight: 400px;\n  font-size: 16px;\n  line-height: 24px;\n}\n.to-adress {\n  width: 224px;\n  height: 36px;\n  border-radius: 20px;\n  border: 2px solid rgba(203, 17, 171, 0.15);\n  padding: 0 0 2px 0;\n  background-color: var(--white);\n  color: var(--black);\n  margin-right: 20px;\n}\n.to-adress.border-active {\n  border: 2px solid var(--magenta);\n}\n@media (max-width: 20em) {\n  .to-adress {\n    margin-right: 8px;\n    font-weight: 700;\n  }\n}\n\n.by-courier {\n  width: 224px;\n  height: 36px;\n  border-radius: 20px;\n  border: 2px solid rgba(203, 17, 171, 0.15);\n  padding: 0 0 2px 0;\n  background-color: var(--white);\n  color: var(--black);\n}\n.by-courier.border-active {\n  border: 2px solid var(--magenta);\n}\n@media (max-width: 20em) {\n  .by-courier {\n    font-weight: 700;\n  }\n}\n\n.bucket__receiver {\n  background-color: var(--white);\n  padding: 17px 24px 24px 24px;\n  border-radius: 16px;\n  color: var(--light-gray);\n}\n@media (max-width: 41.250em) {\n  .bucket__receiver {\n    width: 100vw;\n    padding: 10px 16px 24px 16px;\n    margin-left: -16px;\n  }\n}\n@media (max-width: 20em) {\n  .bucket__receiver {\n    max-width: 320px;\n    margin-left: -16px;\n    padding: 10px 16px 24px 16px;\n    margin-bottom: 16px;\n  }\n}\n.bucket__receiver h2 {\n  max-width: 755px;\n  width: 100%;\n  font-size: 24px;\n  font-weight: 700;\n  line-height: 32px;\n  letter-spacing: -1%;\n  margin-right: 10px;\n  margin-bottom: 16px;\n  color: var(--black);\n}\n@media (max-width: 20em) {\n  .bucket__receiver h2 {\n    font-size: 20px;\n    line-height: 30px;\n    letter-spacing: -0.2px;\n    margin-bottom: 5px;\n  }\n}\n\n.receiver__name {\n  max-width: 700px;\n  display: flex;\n  align-items: center;\n  margin-bottom: 1px;\n}\n@media (max-width: 41.250em) {\n  .receiver__name {\n    flex-direction: column;\n  }\n}\n@media (max-width: 20em) {\n  .receiver__name {\n    flex-direction: column;\n  }\n}\n\n.receiver__more {\n  max-width: 700px;\n  display: flex;\n  align-items: center;\n}\n@media (max-width: 41.250em) {\n  .receiver__more {\n    flex-direction: column;\n  }\n}\n@media (max-width: 20em) {\n  .receiver__more {\n    flex-direction: column;\n  }\n}\n\n.name__name {\n  flex: 1 1 50%;\n  margin-right: 24px;\n}\n@media (max-width: 41.250em) {\n  .name__name {\n    width: 100%;\n    margin: 0 0 10px 0;\n  }\n}\n@media (max-width: 20em) {\n  .name__name {\n    width: 288px;\n    margin: 0 0 10px 0;\n  }\n}\n.name__name-title {\n  font-weight: 400;\n  font-size: 13px;\n  line-height: 16px;\n  margin-bottom: 2px;\n  visibility: hidden;\n}\n.name__name-title.active-hat {\n  visibility: visible;\n}\n.name__name-input {\n  width: 100%;\n  border-bottom: 2px solid var(--light-gray);\n  font-weight: 400;\n  font-size: 16px;\n  line-height: 24px;\n  margin-bottom: 4px;\n}\n.name__name-input.error {\n  color: red;\n}\n.name__name-help {\n  font-weight: 400;\n  font-size: 12px;\n  line-height: 14px;\n  visibility: hidden;\n}\n.name__name-help.error {\n  color: red;\n  visibility: visible;\n}\n.name__second {\n  flex: 1 1 50%;\n  width: 100%;\n}\n@media (max-width: 41.250em) {\n  .name__second {\n    width: 100%;\n  }\n}\n@media (max-width: 20em) {\n  .name__second {\n    width: 288px;\n    margin-bottom: 9px;\n  }\n}\n.name__second-title {\n  font-weight: 400;\n  font-size: 13px;\n  line-height: 16px;\n  margin-bottom: 2px;\n  visibility: hidden;\n}\n.name__second-title.active-hat {\n  visibility: visible;\n}\n.name__second-input {\n  width: 100%;\n  border-bottom: 2px solid var(--light-gray);\n  font-weight: 400;\n  font-size: 16px;\n  line-height: 24px;\n  margin-bottom: 4px;\n}\n.name__second-input.error {\n  color: red;\n}\n.name__second-help {\n  font-weight: 400;\n  font-size: 12px;\n  line-height: 14px;\n  visibility: hidden;\n}\n.name__second-help.error {\n  color: red;\n  visibility: visible;\n}\n\n.more__email {\n  flex: 1 1 33.3%;\n  margin-right: 24px;\n}\n@media (max-width: 41.250em) {\n  .more__email {\n    width: 100%;\n    margin: 0 0 8px 0;\n  }\n}\n@media (max-width: 20em) {\n  .more__email {\n    width: 288px;\n    margin: 0 0 8px 0;\n  }\n}\n.more__email-title {\n  font-weight: 400;\n  font-size: 13px;\n  line-height: 16px;\n  margin-bottom: 2px;\n  visibility: hidden;\n}\n.more__email-title.active-hat {\n  visibility: visible;\n}\n.more-email {\n  font-weight: 400;\n  font-size: 16px;\n  line-height: 24px;\n  border-bottom: 2px solid var(--light-gray);\n  width: 100%;\n  margin-bottom: 7px;\n}\n.more-email.error {\n  color: red;\n}\n.more__email-help {\n  font-weight: 400;\n  font-size: 12px;\n  line-height: 14px;\n  visibility: hidden;\n}\n.more__email-help.error {\n  color: red;\n  visibility: visible;\n}\n.more__tel {\n  flex: 1 1 33.3%;\n  margin-right: 24px;\n}\n.more__tel.error {\n  color: red;\n}\n@media (max-width: 41.250em) {\n  .more__tel {\n    width: 100%;\n    margin: 0 0 8px 0;\n  }\n}\n@media (max-width: 20em) {\n  .more__tel {\n    width: 288px;\n    margin: 0 0 6px 0;\n  }\n}\n.more__tel-title {\n  font-weight: 400;\n  font-size: 13px;\n  line-height: 16px;\n  margin-bottom: 2px;\n  visibility: hidden;\n}\n.more__tel-title.active-hat {\n  visibility: visible;\n}\n.more-tel {\n  font-weight: 400;\n  font-size: 16px;\n  line-height: 24px;\n  border-bottom: 2px solid var(--light-gray);\n  width: 100%;\n  margin-bottom: 7px;\n}\n.more-tel.error {\n  color: red;\n}\n.more-tel::placeholder {\n  color: var(--black);\n}\n.more__tel-help {\n  font-weight: 400;\n  font-size: 12px;\n  line-height: 14px;\n  visibility: hidden;\n}\n.more__tel-help.error {\n  color: red;\n  visibility: visible;\n}\n.more__number {\n  flex: 1 1 33.3%;\n}\n.more__number.error {\n  color: red;\n}\n@media (max-width: 41.250em) {\n  .more__number {\n    width: 100%;\n  }\n}\n@media (max-width: 20em) {\n  .more__number {\n    width: 288px;\n  }\n}\n.more__number-title {\n  font-weight: 400;\n  font-size: 13px;\n  line-height: 16px;\n  margin-bottom: 2px;\n  visibility: hidden;\n}\n.more__number-title.active-hat {\n  visibility: visible;\n}\n.more-number {\n  font-weight: 400;\n  font-size: 16px;\n  line-height: 24px;\n  border-bottom: 2px solid var(--light-gray);\n  width: 100%;\n  margin-bottom: 7px;\n}\n@media (max-width: 20em) {\n  .more-number {\n    margin-bottom: 3px;\n  }\n}\n.more-number.error {\n  color: red;\n}\n.more__number-help {\n  font-weight: 400;\n  font-size: 12px;\n  line-height: 14px;\n  visibility: hidden;\n}\n.more__number-help.error {\n  color: red;\n  visibility: visible;\n}\n\n.bill__info {\n  margin-bottom: 24px;\n}\n\n.info__total {\n  display: flex;\n  font-weight: 700;\n  font-size: 24px;\n  line-height: 32px;\n  margin-bottom: 4px;\n}\n@media (max-width: 20em) {\n  .info__total {\n    font-size: 20px;\n    line-height: 34px;\n    letter-spacing: -0.2px;\n    margin-bottom: 2px;\n  }\n}\n.info__total h2 {\n  display: block;\n  flex: 1 1 auto;\n}\n.info__pieces {\n  display: flex;\n  font-weight: 400;\n  font-size: 16px;\n  line-height: 24px;\n}\n@media (max-width: 20em) {\n  .info__pieces {\n    margin-bottom: -2px;\n  }\n}\n.info__pieces h2 {\n  display: block;\n  flex: 1 1 auto;\n}\n.info__sale {\n  display: flex;\n  font-weight: 400;\n  font-size: 16px;\n  line-height: 28px;\n}\n.info__sale h2 {\n  display: block;\n  flex: 1 1 auto;\n}\n.info__date {\n  color: var(--magenta);\n  font-size: 13px;\n  line-height: 16px;\n  margin-bottom: 13px;\n}\n@media (max-width: 20em) {\n  .info__date {\n    display: none;\n  }\n}\n.info__back {\n  padding: 8px 8px 12px 8px;\n  display: flex;\n  background-color: var(--smoky);\n  border-radius: 8px;\n  margin-bottom: 28px;\n  position: relative;\n}\n@media (max-width: 20em) {\n  .info__back {\n    background-color: var(--smoky-dark);\n    margin-bottom: -5px;\n  }\n}\n.info__back span {\n  position: relative;\n  width: 22px;\n  height: 20px;\n  top: 7px;\n  left: 0px;\n  margin-right: 10px;\n  border-radius: 50%;\n}\n@media (max-width: 20em) {\n  .info__back span {\n    margin-right: 15px;\n  }\n}\n.info__back span::before {\n  content: \"\";\n  width: 20px;\n  height: 20px;\n  position: absolute;\n  top: 2px;\n  left: 2px;\n  border-radius: 50%;\n  background: var(--white);\n  border: 2px solid var(--gradient-start);\n}\n.info__back span::after {\n  content: \"\";\n  left: 3px;\n  top: 4px;\n  position: absolute;\n  height: 15px;\n  width: 15px;\n  background-image: url(\"/src/assets/images/Tick.svg\");\n  background-repeat: no-repeat;\n  background-position: 65% 50%;\n}\n.info__back .back__about {\n  visibility: hidden;\n  position: absolute;\n  top: 48px;\n  left: 5%;\n  width: 288px;\n  height: 56px;\n  padding: 10px 16px 14px 16px;\n  border-radius: 8px;\n  background-color: var(--white);\n  box-shadow: 0 0 10px rgba(0, 0, 0, 0.15);\n}\n.info__back div {\n  font-weight: 400;\n  font-size: 13px;\n  line-height: 16px;\n  padding: 2px 0 0 0;\n}\n.info__back div a {\n  color: var(--green);\n  border-bottom: 1px dashed var(--light-green);\n}\n.info__back div a:hover + .back__about {\n  visibility: visible;\n}\n.info__delivery {\n  display: flex;\n  font-weight: 400;\n  font-size: 16px;\n  line-height: 24px;\n  margin-bottom: 24px;\n}\n@media (max-width: 20em) {\n  .info__delivery {\n    margin-top: -2px;\n    margin-bottom: 14px;\n  }\n}\n.info__delivery h2 {\n  display: block;\n  flex: 1 1 auto;\n}\n.total__value {\n  margin-right: 3px;\n  letter-spacing: 1%;\n}\n@media (max-width: 20em) {\n  .total__value {\n    font-size: 20px;\n    line-height: 34px;\n    letter-spacing: -0.05px;\n  }\n}\n.total__currency {\n  font-size: 20px;\n  line-height: 36px;\n}\n\n.pieces__value {\n  margin-right: 3px;\n}\n.sale__value {\n  margin-right: 3px;\n}\n\n.place__edit {\n  display: flex;\n  justify-content: space-between;\n  margin-bottom: 8px;\n}\n@media (max-width: 20em) {\n  .place__edit {\n    display: none;\n  }\n}\n.place__edit2 {\n  display: flex;\n  justify-content: space-between;\n}\n@media (max-width: 20em) {\n  .place__edit2 {\n    display: none;\n  }\n}\n.place__title {\n  font-weight: 700;\n  font-size: 16px;\n  line-height: 16px;\n}\n.place__button {\n  width: 16px;\n  height: 16px;\n  background-image: url(/src/assets/images/edit.svg);\n  background-color: transparent;\n}\n.place__address {\n  font-weight: 400;\n  font-size: 13px;\n  line-height: 16px;\n  margin-bottom: 4px;\n}\n@media (max-width: 20em) {\n  .place__address {\n    display: none;\n  }\n}\n\n.pay__system1 {\n  margin-top: 10px;\n  display: flex;\n  font-size: 13px;\n  align-items: center;\n  margin-bottom: 10px;\n}\n\n.card__system {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  background-color: var(--smoky);\n  width: 32px;\n  height: 24px;\n  border-radius: 4px;\n  margin-right: 9px;\n}\n@media (max-width: 20em) {\n  .card__system {\n    display: none;\n  }\n}\n\n.pay__number {\n  font-weight: 400;\n  font-size: 13px;\n  line-height: 22px;\n  text-align: right;\n}\n@media (max-width: 20em) {\n  .pay__number {\n    display: none;\n  }\n}\n\n.info__instant {\n  background-color: var(--smoky);\n  border-radius: 8px;\n  padding: 8px 8px 12px 8px;\n}\n@media (max-width: 20em) {\n  .info__instant {\n    background-color: var(--smoky-dark);\n  }\n}\n.info__instant p {\n  font-weight: 400;\n  font-size: 13px;\n  line-height: 16px;\n}\n\n.instant__input {\n  display: flex;\n  margin-bottom: 8px;\n  cursor: pointer;\n}\n.instant__input input {\n  display: none;\n}\n.instant__input p {\n  font-weight: 400;\n  font-size: 13px;\n  line-height: 22px;\n}\n\n.input__checkbox {\n  position: relative;\n  width: 22px;\n  height: 22px;\n  margin-right: 8px;\n}\n.input__checkbox.instant__pay::before {\n  content: \"\";\n  position: absolute;\n  width: 22px;\n  height: 22px;\n  background-color: var(--magenta);\n  border: none;\n  left: 0;\n  top: 0;\n  border-radius: 6px;\n  background-image: url(\"/src/assets/images/Input.svg\");\n  background-repeat: no-repeat;\n  background-position: 50% 50%;\n}\n.input__checkbox::before {\n  content: \"\";\n  position: absolute;\n  width: 22px;\n  height: 22px;\n  background-color: var(--smoky);\n  border: 1px solid var(--light-gray);\n  left: 0;\n  top: 0;\n  border-radius: 6px;\n}\n\n.bill__button {\n  background-color: var(--magenta);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  height: 44px;\n  border-radius: 8px;\n  padding: 0 32px 5px 32px;\n  margin-bottom: 10px;\n  cursor: pointer;\n}\n@media (max-width: 20em) {\n  .bill__button {\n    margin-bottom: 14px;\n  }\n}\n.bill__button button {\n  font-size: 16px;\n  width: 100%;\n  height: 100%;\n  font-weight: 700;\n  text-align: center;\n  line-height: 24px;\n  background-color: transparent;\n  color: var(--white);\n}\n\n.bill__rules {\n  display: flex;\n  align-items: flex-start;\n  font-size: 13px;\n  line-height: 16px;\n  font-weight: 400;\n}\n.bill__rules p {\n  font-weight: 400;\n  font-size: 13px;\n  line-height: 16px;\n}\n.bill__rules a {\n  color: var(--black);\n  position: relative;\n  border-bottom: 1px solid var(--rulers);\n}\n\n.rules__checkbox {\n  width: 13px;\n  height: 24px;\n  position: relative;\n  margin-right: 10px;\n}\n.rules__checkbox input {\n  display: none;\n}\n.rules__checkbox::before {\n  content: \"\";\n  position: absolute;\n  width: 12.51px;\n  height: 10.16px;\n  top: 3.32px;\n  left: 0.26px;\n  background-image: url(/src/assets/images/black_tick.svg);\n  background-repeat: no-repeat;\n}\n\n.footer {\n  height: 88px;\n  width: 100%;\n  background-color: var(--violet);\n}\n\n.footer__back {\n  background-color: var(--smoky);\n  width: 100%;\n  height: 45px;\n  border-radius: 0 0 24px 24px;\n}\n\n.footer__rights {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-weight: 400;\n  font-size: 13px;\n  height: 100%;\n  line-height: 16px;\n  text-align: center;\n  color: var(--light-white);\n  letter-spacing: 1%;\n}\n@media (max-width: 20em) {\n  .footer__rights {\n    padding: 40px 0 90px 0;\n  }\n}\n\n:root {\n  --violet: rgba(103, 37, 168, 1);\n  --white: rgba(255, 255, 255, 1);\n  --search-bar: rgba(255, 255, 255, 0.2);\n  --search-bar-hover: rgba(255, 255, 255, 0.5);\n  --black: rgba(0, 0, 0, 1);\n  --magenta: rgba(203, 17, 171, 1);\n  --gray: rgba(151, 151, 175, 1);\n  --light-gray: rgba(160, 160, 164, 1);\n  --rulers: rgba(0, 0, 0, 0.2);\n  --coral: rgba(255, 59, 48, 1);\n  --green: rgba(12, 180, 119, 1);\n  --light-green: rgba(12, 180, 119, 0.2);\n  --gradient-start: rgba(12, 211, 139, 1);\n  --gradient-end: rgba(12, 180, 119, 1);\n  --smoky: rgba(246, 246, 250, 1);\n  --smoky-dark: rgba(240, 236, 244, 1);\n  --orange: rgba(245, 81, 35, 1);\n  --deep-orange: rgba(255, 151, 13, 1);\n  --light-white: rgba(255, 255, 255, 0.7) ;\n}\n\nbody {\n  background: var(--violet);\n  font-family: var(--font-segoe);\n  display: flex;\n  flex-direction: column;\n  position: relative;\n}\nbody.overflow {\n  overflow-y: hidden;\n}\nbody::after {\n  content: \"\";\n  position: absolute;\n  top: 89px;\n  left: 0;\n  border-radius: 25px 25px 0 0;\n  background-color: var(--smoky);\n  width: 100%;\n  height: 24px;\n}\n@media (max-width: 20em) {\n  body::after {\n    display: none;\n  }\n}\n\n.container {\n  max-width: 1400px;\n  margin: 0 auto;\n  overflow: hidden;\n}\n\nheader {\n  width: 100%;\n}\n\nmain {\n  width: 100%;\n  min-height: 1825px;\n  margin: 1 1 auto;\n}\n@media (max-width: 41.250em) {\n  main {\n    min-height: 2950.33px;\n  }\n}\n@media (max-width: 20em) {\n  main {\n    min-height: 2717.33px;\n  }\n}\n\nfooter {\n  width: 100%;\n  height: 100%;\n}\n@media (max-width: 20em) {\n  footer {\n    min-height: 88px;\n  }\n}\n\n.mobile__nav {\n  display: none;\n  position: fixed;\n  left: 0;\n  bottom: 0;\n  background-color: var(--white);\n  width: 320px;\n  height: 56px;\n  padding: 0 13px 0 13px;\n  z-index: 10;\n}\n.mobile__nav img {\n  width: 28px;\n  height: 28px;\n}\n@media (max-width: 62.250em) {\n  .mobile__nav img {\n    margin-right: 120px;\n  }\n  .mobile__nav img:last-child {\n    margin-right: 0;\n  }\n}\n@media (max-width: 41.250em) {\n  .mobile__nav img {\n    margin-right: 45px;\n  }\n  .mobile__nav img:last-child {\n    margin-right: 0;\n  }\n}\n@media (max-width: 20em) {\n  .mobile__nav img {\n    margin-right: 38.5px;\n  }\n  .mobile__nav img:last-child {\n    margin-right: 0;\n  }\n}\n@media (max-width: 62.250em) {\n  .mobile__nav {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    max-width: 996px;\n    width: 100%;\n    padding: 0 70px 0 70px;\n  }\n}\n@media (max-width: 20em) {\n  .mobile__nav {\n    display: flex;\n    align-items: center;\n    justify-content: left;\n    width: 320px;\n    padding: 0 13px 0 13px;\n  }\n}\n\n:root {\n  --font-segoe: \"Segoe UI\", sans-serif;\n}\n\n@font-face {\n  font-family: \"Segoe UI\";\n  src: url(\"../../assets/fonts/SegoeUI-SemiBold.eot\");\n  src: local(\"Segoe UI Semibold\"), local(\"SegoeUI-SemiBold\"), url(\"../../assets/fonts/SegoeUI-SemiBold.eot?#iefix\") format(\"embedded-opentype\"), url(\"../../assets/fonts/SegoeUI-SemiBold.woff\") format(\"woff\"), url(\"../../assets/fonts/SegoeUI-SemiBold.ttf\") format(\"truetype\");\n  font-weight: 600;\n  font-style: normal;\n}\n@font-face {\n  font-family: \"Segoe UI\";\n  src: url(\"../../assets/fonts/SegoeUI.eot\");\n  src: local(\"Segoe UI\"), local(\"SegoeUI\"), url(\"../../assets/fonts/SegoeUI.eot?#iefix\") format(\"embedded-opentype\"), url(\"../../assets/fonts/SegoeUI.woff\") format(\"woff\"), url(\"../../assets/fonts/SegoeUI.ttf\") format(\"truetype\");\n  font-weight: 400;\n  font-style: normal;\n}\n@font-face {\n  font-family: \"Segoe UI\";\n  src: url(\"../../assets/fonts/SegoeUI-Bold.eot\");\n  src: local(\"Segoe UI Bold\"), local(\"SegoeUI-Bold\"), url(\"../../assets/fonts/SegoeUI-Bold.eot?#iefix\") format(\"embedded-opentype\"), url(\"../../assets/fonts/SegoeUI-Bold.woff\") format(\"woff\"), url(\"../../assets/fonts/SegoeUI-Bold.ttf\") format(\"truetype\");\n  font-weight: 700;\n  font-style: normal;\n}","@use '../util' as *;\n\n.header {\n    font-family: var(--font-segoe);\n    color: var(--white);\n}\n.header__wrapper {\n    display: flex;\n    width: 100%;\n    align-items: center;\n    height: 112px;\n    padding: 20px 3px 44px 24px;\n\n    @include breakpoint(tablet) {\n        justify-content: space-between;\n    }\n\n    @include breakpoint(phone) {\n        justify-content: flex-start;\n        padding: 0 13px 0 13px;\n        height: 56px;\n    }\n}\n.menu {\n    display: flex;\n    align-items: center;\n    margin-right: 32px;\n    max-width: 170px;\n    height: 56px;\n\n    button {\n        position: relative;\n        &::after {\n            content: '';\n            position: absolute;\n            border-radius: 8px;\n            left: 10px;\n            top: 50%;\n            transform: translateY(-50%);\n            background: var(--white);\n            width: 28px;\n            height: 4px;\n        }\n    }\n\n    &__catalog {\n        width: 48px;\n        height: 48px;\n        background: transparent;\n        border-radius: 8px;\n        border: 1px solid rgba(255, 255, 255, 0.45);\n        margin-right: 16px;\n        position: relative;\n        cursor: pointer;\n\n        &:hover {\n            border: 1px solid rgba(255, 255, 255, 1);\n        }\n\n        @include breakpoint(tablet) {\n            display: none;\n        }\n\n        @include breakpoint(phone) {\n            display: none;\n        }\n\n        &::before {\n            content: '';\n            position: absolute;\n            border-radius: 8px;\n            left: 9px;\n            top: 13px;\n            transform: translateY(-50%);\n            background: var(--white);\n            width: 28px;\n            height: 4px;\n        }\n\n        &::after {\n            content: '';\n            position: absolute;\n            border-radius: 8px;\n            left: 9px;\n            bottom: 13px;\n            transform: translateY(50%);\n            background: var(--white);\n            width: 28px;\n            height: 4px;\n        }\n        span {\n            content: '';\n            position: absolute;\n            border-radius: 8px;\n            left: 9px;\n            top: 50%;\n            transform: translateY(-50%);\n            background: var(--white);\n            width: 28px;\n            height: 4px;\n        }\n    }\n\n    &__catalog-mobile {\n        display: none;\n        width: 44px;\n        height: 44px;\n        background: transparent;\n        border-radius: 8px;\n        margin-right: 16px;\n        position: relative;\n        cursor: pointer;\n\n        @include breakpoint(tablet) {\n            display: block;\n        }\n\n        @include breakpoint(phone) {\n            display: block;\n        }\n\n        &::before {\n            content: '';\n            position: absolute;\n            border-radius: 10px;\n            left: 3px;\n            top: 14px;\n            transform: translateY(-50%);\n            background: var(--white);\n            width: 22px;\n            height: 2px;\n        }\n\n        &::after {\n            content: '';\n            position: absolute;\n            border-radius: 10px;\n            left: 3px;\n            bottom: 14px;\n            transform: translateY(50%);\n            background: var(--white);\n            width: 16px;\n            height: 2px;\n        }\n        span {\n            content: '';\n            position: absolute;\n            border-radius: 10px;\n            left: 3px;\n            top: 50%;\n            transform: translateY(-50%);\n            background: var(--white);\n            width: 22px;\n            height: 2px;\n        }\n    }\n\n    &__logo {\n        display: flex;\n        align-items: center;\n        font-size: 22px;\n        font-weight: 600;\n        line-height: 24px;\n        letter-spacing: 1.68px;\n        text-transform: uppercase;\n        max-width: 106px;\n        height: 56px;\n        cursor: pointer;\n\n        @include breakpoint(tablet) {\n            white-space: nowrap;\n        }\n        \n\n        @include breakpoint(phone) {\n            padding: 0 0 4px 32px;\n            white-space: nowrap;\n            font-size: 20px;\n            max-width: 198px;\n            line-height: 34px;\n            letter-spacing: 2px;\n        }\n    }\n}\n.search {\n    flex: 1 1 auto;\n    display: flex;\n    align-items: center;\n    margin-right: 32px;\n    padding: 0 20px 0 20px;\n    border-radius: 36px;\n    max-width: 970px;\n    height: 48px;\n    background: var(--search-bar);\n    cursor: pointer;\n    transition: all 0.2s ease-in-out;\n\n    &:hover {\n        background: var(--search-bar-hover);\n    }\n\n    @include breakpoint(tablet) {\n        display: none;\n    }\n\n    @include breakpoint(phone) {\n        display: none;\n    }\n\n    &__bar {\n        flex: 1 1 auto;\n        width: 100%;\n        background-color: transparent;\n        color: var(--white);\n        font-weight: 400;\n        font-size: 18px;\n        position: relative;\n        cursor: pointer;\n        padding: 0 0 4px 0;\n\n        &::placeholder {\n            font-family: var(--font-segoe);\n            color: var(--white);\n            opacity: 0.5;\n            font-weight: 400;\n            line-height: 24px;\n        }\n    }\n\n    svg {\n        display: inline-block;\n        opacity: 0.4;\n        width: 22px;\n        height: 22px;\n        \n        &:hover {\n            opacity: 1;\n        }\n    }\n}\n.about {\n    max-width: 169px;\n    height: 56px;\n    padding: 0 17px 0 0;\n    display: flex;\n    font-size: 13px;\n    line-height: 16px;\n    font-weight: 400;\n\n    @include breakpoint(tablet) {\n        display: none;\n    }\n\n    @include breakpoint(phone) {\n        display: none;\n    }\n\n    &__profile {\n        display: flex;\n        flex-direction: column;\n        align-items: center;\n        justify-content: space-around;\n        width: 56px;\n        height: 56px;\n        margin-right: 40px;\n        padding: 0 0 3px 0;\n        cursor: pointer;\n    }\n\n    &__bucket {\n        display: flex;\n        flex-direction: column;\n        align-items: center;\n        justify-content: space-around;\n        width: 56px;\n        height: 56px;\n        position: relative;\n        cursor: pointer;\n \n        img {\n            padding: 0 10px 0 0;\n        }\n\n        &-counter {\n            width: 16px;\n            height: 16px;\n            position: absolute;\n            top: -3px;\n            left: 31px;\n            border-radius: 16px;\n            padding: 0 2px 0 2px;\n            background: var(--orange);\n            font-size: 10px;\n            font-weight: 700;\n            line-height: 15px;\n            text-align: center;\n        }\n    }\n\n    &__image {\n        display: flex;\n        align-items: center;\n        justify-content: center;\n        margin-bottom: 6px;\n        height: 30px;\n    }\n}\n.search__mobile {\n    display: none;\n\n    @include breakpoint(tablet) {\n        display: block;\n        position: relative;\n\n        img {\n            position: absolute;\n            left: -50px;\n            top: -2px;\n        }\n    }\n\n    @include breakpoint(phone) {\n        display: block;\n        position: relative;\n\n        img {\n            position: absolute;\n            left: 67px;\n            top: -2px;\n        }\n    }\n}","$breakpoint-down: (\r\n    'phone': '20em',\r\n    'tabphone': '41.250em',\r\n    'tablet': '62.250em',\r\n    'desktop': '87.5em',\r\n);\r\n\r\n@mixin breakpoint($size) {\r\n    @media (max-width: map-get($breakpoint-down, $size)) {\r\n        @content;\r\n    }\r\n}","@use '../util' as *;\n\n.main {\n    font-family: var(--font-segoe);\n    color: var(--black);\n    height: 100%;\n    background-color: var(--smoky);\n\n    @include breakpoint(phone) {\n        border-radius: 25px 25px 0 0;\n    }\n}\n.main__wrapper {\n    display: flex;\n    width: 100%;\n    height: 100%;\n    justify-content: space-between;\n    padding: 10px 24px 16px 24px;\n    position: relative;\n    \n    @include breakpoint(tablet) {\n        flex-direction: column;\n        padding: 0 16px 0 16px;\n    }\n\n    @include breakpoint(phone) {\n        flex-direction: column;\n        padding: 0 16px 0 16px;\n    }\n}\n.main__bucket {\n    max-width: 891px;\n    min-width: 640px;\n    width: 100%;\n    height: 100%;\n    margin-right: 32px;\n\n    @include breakpoint(tablet) {\n        margin-bottom: 80px;\n    }\n\n    // @include breakpoint(tabphone) {\n    //     margin-bottom: 80px;\n    //     max-width: 100vw;\n    // }\n\n    @include breakpoint(phone) {\n        max-width: 288px;\n        margin-right: 0;\n        margin-bottom: 0;\n    }\n\n    h1 {\n        font-size: 28px;\n        font-weight: 700;\n        line-height: 40px;\n        margin-bottom: 23px;\n\n        @include breakpoint(phone) {\n            font-size: 20px;\n            line-height: 32px;\n            padding: 14px 0 0 0;\n        }\n    }\n}\n.main__bill {\n    background-color: var(--white);\n    border-radius: 16px;\n    padding: 16px 24px 24px 24px;\n    z-index: 1;\n    max-width: 429px;\n    max-height: 572px;\n    box-shadow: 0 0 10px rgba(0, 0, 0, 0.15);\n    margin-top: -12px;\n\n    @include breakpoint(tablet) {\n        max-width: 996px;\n        margin-bottom: 70px;\n    }\n\n    @include breakpoint(phone) {\n        max-width: 429px;\n        background-color: transparent;\n        box-shadow: none;\n        padding: 16px 0 24px 0;\n        margin-bottom: 0;\n    }\n}","@use '../util/' as *;\n\n.bucket__available {\n    margin-bottom: 40px;\n\n    @include breakpoint(tabphone) {\n        width: 100vw;\n        padding: 10px 16px 24px 16px;\n        margin-left: -16px;\n    }\n\n    @include breakpoint(phone) {\n        width: 100%;\n        margin-top: -10px;\n        margin-bottom: 35px;\n        padding: 0;\n        margin-left: 0;\n    }\n}\n.choose-all {\n    display: flex;\n    align-items: center;\n    position: relative;\n    height: 24px;\n    margin-bottom: 16px;\n    user-select: none;\n\n    @include breakpoint(tabphone) {\n        max-width: 670px;\n    }\n\n    @include breakpoint(phone){\n        max-width: 288px;\n    }\n\n    &__checkbox {\n        flex: 1 1 auto;\n        display: flex;\n        font-weight: 400;\n        font-size: 16px;\n        line-height: 24px;\n        position: relative;\n        padding: 0 0 3px 33px;\n\n        & input {\n            display: none;\n        }\n\n        &::before {\n            content: '';\n            position: absolute;\n            width: 22px;\n            height: 22px;\n            left: 0;\n            top: 2px;\n            cursor: pointer;\n            border-radius: 6px;\n            background-color: transparent;\n            background-image: none;\n            // background-repeat: no-repeat;\n            // background-position: 50% 50%;\n            border: 1px solid var(--rulers);\n\n            @include breakpoint(phone) {\n                background-color: var(--white);\n                background-image: none;\n                border: 1px solid var(--rulers);\n            }\n        }\n\n        &.active-all{\n            &::before {\n                content: '';\n                position: absolute;\n                width: 22px;\n                height: 22px;\n                left: 0;\n                top: 2px;\n                border-radius: 6px;\n                border: 1px solid var(--rulers);\n                background-color: var(--magenta);\n                background-image: url('/src/assets/images/Input.svg');\n                background-repeat: no-repeat;\n                background-position: 50% 50%;\n    \n                @include breakpoint(phone) {\n                    border: 1px solid var(--rulers);\n                    background-color: var(--magenta);\n                    background-image: url('/src/assets/images/Input.svg');\n                    background-repeat: no-repeat;\n                    background-position: 50% 50%;\n                }\n            }\n        }\n    }\n\n    &__hide {\n        cursor: pointer;\n        width: 20px;\n        height: 20px;\n\n        &.reversed-hide {\n            &::before {\n                position: absolute;\n                top: 12px;\n                right: 1px;\n                content: '';\n                width: 11px;\n                height: 2px;\n                transform: rotate(-45deg);\n                background-color: var(--gray);\n    \n                @include breakpoint(phone) {\n                    right: 5px;\n                }\n            }\n    \n            &::after {\n                position: absolute;\n                top: 12px;\n                right: 8px;\n                content: '';\n                width: 11px;\n                height: 2px;\n                transform: rotate(45deg);\n                background-color: var(--gray);\n    \n                @include breakpoint(phone) {\n                    right: 12px;\n                }\n            }\n        }\n        \n        &::before {\n            position: absolute;\n            top: 12px;\n            right: 1px;\n            content: '';\n            width: 11px;\n            height: 2px;\n            transform: rotate(45deg);\n            transition: all 0.2s ease;\n            background-color: var(--gray);\n\n            @include breakpoint(phone) {\n                right: 5px;\n            }\n        }\n\n        &::after {\n            position: absolute;\n            top: 12px;\n            right: 8px;\n            content: '';\n            width: 11px;\n            height: 2px;\n            transform: rotate(-45deg);\n            transition: all 0.2s ease;\n            background-color: var(--gray);\n\n            @include breakpoint(phone) {\n                right: 12px;\n            }\n        }\n    }\n}\n.available__choose-item {\n    display: block;\n    border-top: 0.5px solid rgba(0, 0, 0, 0.2);\n\n    &.hidden{\n        display: none;\n    }\n\n    @include breakpoint(tabphone) {\n        border-top: none;\n    }\n\n\n    @include breakpoint(phone) {\n        max-width: 288px;\n        border-top: none;\n    }\n\n}\n.available__item {\n    display: flex;\n    justify-content: space-between;\n    margin-bottom: 20px;\n\n    @include breakpoint(tabphone) {\n        flex-direction: column;\n        max-width: 670px;\n        border-top: 0.5px solid rgba(0, 0, 0, 0.2);\n    }\n\n    @include breakpoint(phone) {\n        flex-direction: column;\n        margin-bottom: 6px;\n        max-width: 288px;\n        border-top: 0.5px solid rgba(0, 0, 0, 0.2);\n    }\n}\n.item {\n    &__about {\n        padding: 11px 0 0 0;\n        display: flex;\n    }\n\n    &__photo {\n        position: relative;\n        margin-right: 16px;\n        user-select: none;\n    \n        // &.choosen {\n        //     &::before {\n        //         background-color: var(--magenta);\n        //     }\n    \n        //     @include breakpoint(phone) {\n        //         &::before {\n        //             background-color: var(--magenta);\n        //         }\n        //     }\n        // }\n    \n        & img {\n            border-radius: 8px;\n            padding: 0 0 0 34px;\n    \n            @include breakpoint(phone) {\n                width: 80px;\n                height: 108px;\n                padding: 0;\n            }\n        }\n    \n        & input {\n            display: none;\n        }\n    \n        &::before {\n            content: '';\n            position: absolute;\n            width: 22px;\n            height: 22px;\n            left: 0;\n            top: 37.5px;\n            cursor: pointer;\n            border-radius: 6px;\n            background-color: transparent;\n            background-image: none;\n            // background-repeat: no-repeat;\n            // background-position: 50% 50%;\n            border: 1px solid var(--rulers);\n    \n            @include breakpoint(phone) {\n               background-color: var(--white);\n               top: 5px;\n               left: 4px;\n               background-position: 50% 45%;\n            }\n    \n        }\n    \n        &.selected {\n            &::before {\n                content: '';\n                position: absolute;\n                width: 22px;\n                height: 22px;\n                left: 0;\n                top: 37.5px;\n                cursor: pointer;\n                border-radius: 6px;\n                background-color: var(--magenta);\n                background-image: url('/src/assets/images/Input.svg');\n                background-repeat: no-repeat;\n                background-position: 50% 50%;\n        \n                @include breakpoint(phone) {\n                   background-color: var(--white);\n                   top: 5px;\n                   left: 4px;\n                   background-color: var(--magenta);\n                    background-image: url('/src/assets/images/Input.svg');\n                    background-repeat: no-repeat;\n                    background-position: 50% 50%;\n                }\n        \n            }\n        }\n        &.active-size {\n            &::after {\n                display: none;\n                content: '56';\n                position: absolute;\n                width: 22px;\n                height: 22px;\n                left: 4px;\n                bottom: 4px;\n                border-radius: 6px;\n                background-color: var(--smoky);\n                text-align: center;\n                font-weight: 400;\n                font-size: 14px;\n                line-height: 22px;\n    \n            @include breakpoint(phone) {\n               display: block;\n               bottom: 5px;\n            }\n    \n        }\n        }\n    }\n\n    &__info {\n        max-width: 275px;\n    \n        @include breakpoint(tabphone) {\n            max-width: 392px;\n        }\n    \n        @include breakpoint(phone) {\n            max-width: 275px;\n        }\n    }\n}\n.info {\n    &__name {\n        line-height: 24px;\n        font-size: 16px;\n        font-weight: 400;\n        margin-bottom: 8px;\n        letter-spacing: 0.05px;\n    \n        @include breakpoint(tabphone) {\n            max-width: 210px;\n        }\n    \n        @include breakpoint(phone) {\n            font-size: 14px;\n            line-height: 18px;\n            display: -webkit-box;\n            -webkit-line-clamp: 2;\n            -webkit-box-orient: vertical;  \n            overflow: hidden;\n            max-height: 38px;\n            max-width: 192px;\n        }\n    }\n    &__param {\n        display: flex;\n        font-weight: 400px;\n        font-size: 13px;\n        line-height: 16px;\n        margin-bottom: 8px;\n    }\n    &__color {\n        margin-right: 16px;\n    }\n    &__size {\n        @include breakpoint(phone) {\n            display: none;\n        }\n    }\n    &__location {\n        font-weight: 400px;\n        font-size: 13px;\n        line-height: 16px;\n        margin-bottom: 4px;\n        color: var(--light-gray);\n    }\n}\n.minus-margin {\n    margin-top: -8px;\n}\n.info__company {\n    display: flex;\n    font-weight: 400px;\n    font-size: 13px;\n    line-height: 16px;\n    color: var(--light-gray);\n    position: relative;\n\n    .comp__about-info {\n        visibility: hidden;\n        position: absolute;\n        top: 25px;\n        background-color: var(--white);\n        box-shadow: 0 0 10px rgba(0, 0, 0, 0.15);\n        width: 280px;\n        height: 104px;\n        border-radius: 8px;\n        padding: 11px 16px 11px 16px;\n        color: var(--black);\n        z-index: 2;\n        \n\n        .comp__title {\n            margin-bottom: 8px;\n            font-weight: 700;\n            font-size: 13px;\n            line-height: 16px;\n        }\n        .comp__ogrn {\n            margin-bottom: 8px;\n            font-weight: 400;\n            font-size: 13px;\n            line-height: 16px;\n        }\n        .comp__adress {\n            font-weight: 400;\n            font-size: 13px;\n            line-height: 16px;\n            display: -webkit-box;\n            -webkit-line-clamp: 2;\n            -webkit-box-orient: vertical;  \n            overflow: hidden;\n        }\n    }\n\n    @include breakpoint(phone) {\n        display: none;\n    }\n\n    p {\n        margin-right: 8px;\n    }\n\n    button {\n        text-align: center;\n        width: 16px;\n        height: 16px;\n        border-radius: 50%;\n        background: transparent;\n        border: 1px solid var(--light-gray);\n        color: var(--gray);\n        font-size: 10px;\n        font-weight: 700;\n\n        &:hover + .comp__about-info {\n            visibility: visible;\n        }\n    }\n}\n.item__counter {\n    display: flex;\n    padding: 9px 0 0 0;\n}\n.item__count {\n    margin-right: 16px;\n    padding: 3px 0 0 0;\n    width: 100px;\n    height: 44px;\n\n    @include breakpoint(tabphone) {\n        display: flex;\n    }\n\n    @include breakpoint(phone) {\n        display: none;\n    }\n}\n.count {\n    &__number {\n        display: flex;\n        align-items: center;\n        justify-content: center;\n        font-size: 16px;\n        line-height: 24px;\n        font-weight: 400;\n        width: 100px;\n        height: 44px;\n        background-color: var(--white);\n        border-radius: 8px;\n        margin-bottom: 8px;\n        position: relative;\n        padding: 8px 3px 13px 4px;\n    \n        @include breakpoint(tabphone) {\n            min-width: 100px;\n            margin-left: 20px;\n            margin-right: 20px;\n        }\n    \n        @include breakpoint(phone) {\n            width: 100px;\n            margin-left: 0;\n            margin-right: 0;\n        }\n    \n        &-minus{\n            position: absolute;\n            left: 16px;\n            top: 48%;\n            transform: translateX(-50%);\n            width: 9px;\n            height: 1px;\n            background: var(--rulers);\n            cursor: pointer;\n        }\n    \n        &-num{\n            color: var(--black);\n            font-size: 15px;\n            padding: 3px 0 0 0;\n        }\n    \n        &-plus{\n            position: absolute;\n            right: 15px;\n            top: 18%;\n            width: 5px;\n            height: 5px;\n            font-size: 20px;\n            line-height: 24px;\n            letter-spacing: -1%;\n            align-items: center;\n            font-weight: 400;\n            transform: translateX(-50%);\n            color: var(--rulers);\n            cursor: pointer;\n    \n            @include breakpoint(phone) {\n                top: 10%;\n                right: 12px;\n            }\n        }\n    \n        .active-color {\n            color: var(--black);\n        }\n        .active-back {\n            background: var(--black);\n        }\n    }\n    \n    &__left {\n        margin-bottom: 8px;\n        color: var(--coral);\n        font-weight: 400;\n        font-size: 13px;\n        line-height: 16px;\n    \n        @include breakpoint(tabphone) {\n            display: flex;\n            align-items: center;\n            justify-content: center;\n            white-space: nowrap;\n            margin-right: 30px;\n            font-size: 16px;\n        }\n    \n        @include breakpoint(phone) {\n            display: none;\n            white-space: nowrap;\n            font-size: 13px;\n            width: 100px;\n            margin-right: 0;\n        }\n    }\n    &__liked {\n        display: flex;\n        width: 100%;\n        justify-content: flex-end;\n        align-items: center;\n        padding-right: 3px;\n    \n        @include breakpoint(phone) {\n            justify-content: center;\n        }\n    }\n    &__like {\n        margin-right: 18px;\n        width: 20px;\n        height: 20px;\n    \n        &:hover{\n            cursor: pointer;\n          \n                path{\n                    fill: var(--magenta);\n                }\n        }\n    \n    \n        @include breakpoint(phone) {\n            margin-right: 20px;\n        }\n    }\n    &__remove {\n        width: 16px;\n        height: 17px;\n    \n        &:hover{\n            cursor: pointer;\n          \n                path{\n                    fill: var(--orange);\n                }\n        }\n    }\n}\n.item__price {\n    width: 110px;\n    height: 44px;\n\n    @include breakpoint(tabphone) {\n        display: none;\n    }\n\n    @include breakpoint(phone) {\n        display: none;\n    }\n}\n.price {\n    &__current {\n        display: flex;\n        justify-content: flex-end;\n        align-items: flex-end;\n        margin-bottom: 5px;\n    \n        .value {\n            font-weight: 700;\n            font-size: 20px;\n            line-height: 25px;\n            letter-spacing: 0;\n            margin-right: 5px;\n        }\n    \n        .value__huge {\n            font-weight: 700;\n            font-size: 15px;\n            line-height: 30px;\n            letter-spacing: 0;\n            margin-right: 5px;\n        }\n        .currency {\n            font-weight: 700;\n            font-size: 16px;\n            line-height: 20px;\n        }\n        .currency__huge {\n            font-weight: 700;\n            font-size: 16px;\n            line-height: 30px;\n        }\n    }\n\n    &__previous {\n        display: flex;\n        justify-content: flex-end;\n        position: relative;\n        cursor: pointer;\n        text-decoration: line-through;\n    \n        &:hover .price__difference {\n            visibility: visible;\n        }\n    \n        // &::before {\n        //     content: '';\n        //     position: absolute;\n        //     width: 54px;\n        //     height: 1px;\n        //     right: 0;\n        //     top: 50%;\n        //     transform: translateY(-50%);\n        //     background-color: var(--light-gray);\n        // }\n    \n        .value {\n            font-weight: 400;\n            font-size: 13px;\n            line-height: 20px;\n            color: var(--light-gray);\n            margin-right: 3px;\n            border-bottom: 1px dashed var(--light-gray);\n            \n        }\n        .currency {\n            font-weight: 400;\n            font-size: 13px;\n            line-height: 20px;\n            color: var(--light-gray);\n            border-bottom: 1px dashed var(--light-gray);\n        }\n    }\n    &__previous-huge {\n        display: flex;\n        justify-content: flex-end;\n        position: relative;\n        margin-top: -3px;\n        cursor: pointer;\n    \n        &:hover .price__difference {\n            visibility: visible;\n        }\n    \n        &::before {\n            content: '';\n            position: absolute;\n            width: 83px;\n            height: 1px;\n            right: 0;\n            top: 50%;\n            transform: translateY(-50%);\n            background-color: var(--light-gray);\n        }\n    \n        .value {\n            font-weight: 400;\n            font-size: 13px;\n            line-height: 20px;\n            color: var(--light-gray);\n            margin-right: 3px;\n            border-bottom: 1px dashed var(--light-gray);\n            \n        }\n        .currency {\n            font-weight: 400;\n            font-size: 13px;\n            line-height: 20px;\n            color: var(--light-gray);\n            border-bottom: 1px dashed var(--light-gray);\n        }\n    }\n    &__previous-short {\n        display: flex;\n        justify-content: flex-end;\n        position: relative;\n        cursor: pointer;\n    \n        &:hover .price__difference {\n            visibility: visible;\n        }\n    \n        &::before {\n            content: '';\n            position: absolute;\n            width: 48px;\n            height: 1px;\n            right: 0;\n            top: 50%;\n            transform: translateY(-50%);\n            background-color: var(--light-gray);\n        }\n    \n        .value {\n            font-weight: 400;\n            font-size: 13px;\n            line-height: 24px;\n            color: var(--light-gray);\n            margin-right: 3px;\n            border-bottom: 1px dashed var(--light-gray);\n    \n            @include breakpoint(phone) {\n                height: 22px;\n                line-height: 28px;\n            }\n            \n        }\n        .currency {\n            font-weight: 400;\n            font-size: 13px;\n            line-height: 24px;\n            color: var(--light-gray);\n            border-bottom: 1px dashed var(--light-gray);\n    \n            @include breakpoint(phone) {\n                height: 22px;\n                line-height: 28px;\n            }\n        }\n    }\n}\n.item__price1 {\n    display: none;\n\n    @include breakpoint(tabphone) {\n        display: block;\n        display: flex;\n\n        .price__current {\n            align-items: center;\n            margin-right: 7px;\n            margin-bottom: 2px;\n\n            .value {\n                font-size: 16px;\n                line-height: 26px;\n            }\n\n            .currency {\n                font-size: 16px;\n                line-height: 26px;\n            }\n        }\n        .price__previous {\n            align-items: center;\n\n            .value {\n                font-size: 13px;\n                line-height: 18px;\n            }\n\n            .currency {\n                font-size: 13px;\n                line-height: 18px;\n            }\n        }\n\n        .price__current {\n            align-items: center;\n            margin-right: 7px;\n            \n\n            .value__huge {\n                font-size: 16px;\n                line-height: 26px;\n                white-space: nowrap;\n                letter-spacing: -0.54px;\n            }\n\n            .currency__huge {\n                font-size: 16px;\n                line-height: 26px;\n            }\n        }\n        .price__previous-huge {\n            align-items: center;\n            padding: 4px 0 0 0;\n            letter-spacing: -0.40px;\n            &::before {\n                content: '';\n                position: absolute;\n                width: 78px;\n                height: 1px;\n                right: 0;\n                top: 55%;\n                transform: translateY(-50%);\n                background-color: var(--light-gray);\n            }\n\n            .value {\n                font-size: 13px;\n                line-height: 18px;\n                white-space: nowrap;\n            }\n\n            .currency {\n                font-size: 13px;\n                line-height: 18px;\n            }\n        }\n        .price__previous-short {\n            &::before {\n                content: '';\n                position: absolute;\n                width: 48px;\n                height: 1px;\n                right: 0;\n                top: 50%;\n                transform: translateY(-50%);\n                background-color: var(--light-gray);\n            }\n        }\n    }\n\n    @include breakpoint(phone) {\n        display: block;\n        display: flex;\n\n        .price__current {\n            align-items: center;\n            margin-right: 7px;\n            margin-bottom: 2px;\n\n            .value {\n                font-size: 16px;\n                line-height: 26px;\n            }\n\n            .currency {\n                font-size: 16px;\n                line-height: 26px;\n            }\n        }\n        .price__previous {\n            align-items: center;\n\n            .value {\n                font-size: 13px;\n                line-height: 18px;\n            }\n\n            .currency {\n                font-size: 13px;\n                line-height: 18px;\n            }\n        }\n\n        .price__current {\n            align-items: center;\n            margin-right: 7px;\n            \n\n            .value__huge {\n                font-size: 16px;\n                line-height: 26px;\n                white-space: nowrap;\n                letter-spacing: -0.54px;\n            }\n\n            .currency__huge {\n                font-size: 16px;\n                line-height: 26px;\n            }\n        }\n        .price__previous-huge {\n            align-items: center;\n            padding: 4px 0 0 0;\n            letter-spacing: -0.40px;\n            &::before {\n                content: '';\n                position: absolute;\n                width: 78px;\n                height: 1px;\n                right: 0;\n                top: 55%;\n                transform: translateY(-50%);\n                background-color: var(--light-gray);\n            }\n\n            .value {\n                font-size: 13px;\n                line-height: 18px;\n                white-space: nowrap;\n            }\n\n            .currency {\n                font-size: 13px;\n                line-height: 18px;\n            }\n        }\n        .price__previous-short {\n            &::before {\n                content: '';\n                position: absolute;\n                width: 48px;\n                height: 1px;\n                right: 0;\n                top: 50%;\n                transform: translateY(-50%);\n                background-color: var(--light-gray);\n            }\n        }\n    }\n}\n.item__count-mobile {\n    display: none;\n\n    @include breakpoint(phone) {\n        display: block;\n        display: flex;\n        \n        .count__number {\n            \n            min-width: 80px;\n            height: 36px;\n            background-color: var(--white);\n            border-radius: 6px;\n            margin-right: 16px;\n        \n            &-minus{\n                background: var(--rulers);\n            }\n        \n            &-num{\n                color: var(--black);\n            }\n        \n            &-plus{\n                color: var(--rulers);\n            }\n        \n            .active-color {\n                color: var(--black);\n            }\n            .active-back {\n                background: var(--black);\n            }\n        }\n        \n        .count__left {\n            flex: 0 0 33.3%;\n            display: flex;\n            align-items: center;\n            justify-content: center;\n            color: var(--coral);\n            font-weight: 400;\n            font-size: 13px;\n            line-height: 16px;\n            white-space: nowrap;\n            margin-right: 8px;\n            padding: 0 5px 0 0;\n            \n        }\n        .count__liked {\n            flex: 0 0 33.3%;\n            display: flex;\n            justify-content: center;\n            align-items: center;\n            margin-top: -8px;\n        \n            @include breakpoint(phone) {\n                justify-content: center;\n            }\n        }\n        .count__like {\n            margin-right: 25px;\n            width: 20px;\n            height: 20px;\n        }\n        .count__remove {\n            width: 16px;\n            height: 17px;\n        }\n    }\n}\n.price__difference { \n    visibility: hidden;\n        position: absolute;\n        top: 25px;\n        right: -8px;\n        background-color: var(--white);\n        box-shadow: 0 0 10px rgba(0, 0, 0, 0.15);\n        width: 239px;\n        height: 64px;\n        border-radius: 8px;\n        padding: 11px 16px 11px 16px;\n        z-index: 2;\n}\n.sale-difference {\n    display: flex;\n    justify-content: space-between;\n    margin-bottom: 8px;\n    font-size: 13px;\n    font-weight: 400;\n    line-height: 16px;\n}\n.sale-perc {\n    color: var(--light-gray);\n}\n.sale-dif {\n    color: var(--black);\n}\n.sale__client-difference {\n    display: flex;\n    justify-content: space-between;\n    font-size: 13px;\n    font-weight: 400;\n    line-height: 16px;\n}\n.sale__client-perc {\n    color: var(--light-gray);\n}\n.sale__client-dif {\n    color: var(--black);\n}","@use '../util/' as *;\n\n.bucket__not-available {\n    margin-bottom: 40px;\n\n    @include breakpoint(tabphone) {\n        width: 100vw;\n        padding: 10px 16px 24px 16px;\n        margin-left: -16px;\n    }\n\n    @include breakpoint(phone) {\n        width: 100%;\n        margin-bottom: 27px;\n        padding: 0;\n        margin-left: 0;\n    }\n}\n.not-available__hide {\n    &.reversed-hide {\n        &::before {\n            position: absolute;\n            top: 12px;\n            right: 1px;\n            content: '';\n            width: 11px;\n            height: 2px;\n            transform: rotate(-45deg);\n            background-color: var(--gray);\n\n            @include breakpoint(phone) {\n                right: 5px;\n            }\n        }\n\n        &::after {\n            position: absolute;\n            top: 12px;\n            right: 8px;\n            content: '';\n            width: 11px;\n            height: 2px;\n            transform: rotate(45deg);\n            background-color: var(--gray);\n\n            @include breakpoint(phone) {\n                right: 12px;\n            }\n        }\n    }\n}\n.not-available__hide-item {\n    border-top: 0.5px solid rgba(0, 0, 0, 0.2);\n    display: block;\n\n    &.hidden{\n        display: none;\n    }\n\n    @include breakpoint(tabphone) {\n        border-top: none;\n    }\n\n    @include breakpoint(phone) {\n        border-top: none;\n    }\n}\n.choose__all-not {\n    font-weight: 600;\n    font-size: 16px;\n    line-height: 24px;\n}\n.not-available__item {\n    display: flex;\n    justify-content: space-between;\n    margin-bottom: 20px;\n    color: var(--light-gray);\n\n    @include breakpoint(tabphone) {\n        flex-direction: column;\n        max-width: 100%;\n        border-top: 0.5px solid rgba(0, 0, 0, 0.2);\n        margin-bottom: 8px;\n    }\n\n    @include breakpoint(phone) {\n        flex-direction: column;\n        max-width: 288px;\n        border-top: 0.5px solid rgba(0, 0, 0, 0.2);\n        margin-bottom: 8px;\n    }\n}\n.not-item__about {\n    padding: 12px 0 0 0;\n    display: flex;\n}\n.not-item__photo {\n    position: relative;\n    margin-right: 16px;\n\n    & img {\n        border-radius: 8px;\n        filter: grayscale(100%); \n    }\n\n    & input {\n        display: none;\n    }\n\n    @include breakpoint(phone) {\n\n        img {\n            width: 80px;\n            height: 108px;\n        }\n    }\n}\n.not-item__info {\n    max-width: 309px;\n}\n.not-info {\n    &__name {\n        line-height: 24px;\n        font-size: 16px;\n        font-weight: 400;\n        margin-bottom: 8px;\n    \n        @include breakpoint(tabphone) {\n            font-size: 14px;\n            line-height: 21px;\n            display: -webkit-box;\n            -webkit-line-clamp: 2;\n            -webkit-box-orient: vertical;  \n            overflow: hidden;\n            max-width: 240px;\n        }\n    \n        @include breakpoint(phone) {\n            max-width: none;\n            font-size: 14px;\n            line-height: 21px;\n            display: -webkit-box;\n            -webkit-line-clamp: 2;\n            -webkit-box-orient: vertical;  \n            overflow: hidden;\n        }\n    }\n    &__param {\n        display: flex;\n        font-weight: 400px;\n        font-size: 13px;\n        line-height: 16px;\n        margin-bottom: 8px;\n    }\n    &__color {\n        margin-right: 16px;\n    }\n    &__size {\n    \n        @include breakpoint(phone) {\n            display: none;\n        }\n    }\n}\n.not-item__counter {\n    width: 226px;\n\n    @include breakpoint(tabphone) {\n        width: 400px;\n    }\n\n    @include breakpoint(phone) {\n        width: 226px;\n    }\n}\n.not-item__count {\n    margin-right: 16px;\n    padding: 3px 0 0 0;\n    width: 100px;\n    height: 44px;\n}\n.count {\n}\n.not-count__liked {\n    display: flex;\n    width: 100px;\n    justify-content: flex-end;\n    padding: 10px 2px 0 0;\n\n    @include breakpoint(tabphone) {\n        width: 328px;\n        align-items: flex-end;\n    }\n\n    @include breakpoint(phone) {\n        width: 288px;\n        align-items: flex-end;\n    }\n}\n.not-count__like {\n    margin-right: 18px;\n    width: 20px;\n    height: 20px;\n\n    @include breakpoint(phone) {\n        margin-right: 25px;\n    }\n}\n.not-count__remove {\n    width: 16px;\n    height: 17px;\n\n    @include breakpoint(phone) {\n        margin-right: 5px;\n    }\n}","@use '../util/' as *;\n\n.bucket__delivery {\n    margin-bottom: 16px;\n    background-color: var(--white);\n    padding: 16px 0 24px 0;\n    border-radius: 16px;\n\n    @include breakpoint(tabphone) {\n        max-width: 100vw;\n        margin-left: -16px;\n        padding: 16px 0 24px 0;\n    }\n\n    @include breakpoint(phone) {\n        max-width: 320px;\n        margin-left: -16px;\n        padding: 16px 0 24px 0;\n    }\n}\n.delivery__edit {\n    display: flex;\n    padding: 0 24px 0 24px;\n    margin-bottom: 16px;\n\n    @include breakpoint(phone) {\n        padding: 0 16px 0 16px;\n        margin-bottom: 10px;\n    }\n\n    h2 {\n        max-width: 755px;\n        width: 100%;\n        font-size: 24px;\n        font-weight: 700;\n        line-height: 32px;\n        letter-spacing: -1%;\n        margin-right: 10px;\n\n        @include breakpoint(phone) {\n            font-size: 20px;\n            line-height: 28px;\n            letter-spacing: -0.20px;\n        }\n    }\n\n    button {\n        padding: 7px 0 0 0;\n        width: 78px;\n        color: var(--magenta);\n        font-weight: 700;\n        font-size: 16px;\n        line-height: 24px;\n        text-align: right;\n        background: transparent;\n        cursor: pointer;\n\n        @include breakpoint(phone) {\n            padding: 3px 0 0 0;\n        }\n    }\n}\n.delivery__address {\n    display: flex;\n    padding: 0 24px 0 24px;\n    margin-bottom: 16px;\n\n    @include breakpoint(phone) {\n       flex-direction: column;\n       padding: 0 16px 0 16px;\n    }\n}\n.address {\n    &__title {\n        width: 177px;\n        margin-right: 2px;\n        font-weight: 600;\n        font-size: 16px;\n        line-height: 24px;\n    }\n    &__info {\n    }\n    &__city {\n        font-weight: 400;\n        font-size: 16px;\n        line-height: 24px;\n        margin-bottom: 2px;\n        padding: 2px 0 0 5px;\n    \n        @include breakpoint(phone) {\n            flex-direction: column;\n            padding: 0;\n        }\n    }\n    &__info-more{\n        display: flex;\n    }\n    &__rate {\n        font-weight: 400;\n        font-size: 13px;\n        line-height: 16px;\n        position: relative;\n        margin-right: 8px;\n        padding: 1px 0 0 22px;\n    \n        @include breakpoint(phone) {\n            padding: 0 0 0 16px;\n         }\n    \n        &::before {\n            content: '';\n            position: absolute;\n            left: 3px;\n            top: 2px;\n            width: 15px;\n            height: 15px;\n            background: url('/src/assets/images/Stars.svg');\n            background-repeat: no-repeat;\n            background-position: 50% 50%;\n    \n            @include breakpoint(phone) {\n                left: 0;\n                top: 0;\n                background-position: 0 0;\n             }\n    \n        }\n    }\n    &__timer{\n        font-weight: 400;\n        font-size: 13px;\n        line-height: 16px;\n        padding-top: 1px;\n    }\n}\n.delivery__cost {\n    display: flex;\n    padding: 0 24px 0 24px;\n    margin-bottom: 16px;\n\n    @include breakpoint(phone) {\n    flex-direction: column;\n    padding: 0 16px 0 16px;\n    }\n}\n.cost {\n    &__title {\n        width: 177px;\n        margin-right: 2px;\n        font-weight: 600;\n        font-size: 16px;\n        line-height: 24px;\n    }\n    &__value {\n        font-weight: 400;\n        font-size: 16px;\n        line-height: 24px;\n        padding: 0 0 0 5px;\n    \n        @include breakpoint(phone) {\n            padding: 0;\n        }\n    }\n}\n.delivery__list {\n    margin-bottom: 24px;\n}\n.list {\n    &__order {\n        display: flex;\n        padding: 0 24px 0 24px;\n        margin-bottom: 16px;\n    \n        @include breakpoint(phone) {\n            flex-direction: column;\n            padding: 0 16px 0 16px;\n            margin-bottom: 24px;\n        }\n    }\n    &__date {\n        width: 177px;\n        margin-right: 2px;\n        font-weight: 600;\n        font-size: 16px;\n        line-height: 24px;\n    \n        @include breakpoint(phone) {\n            margin-bottom: 12px;\n        }\n    }\n    &__items {\n        padding: 0 0 0 5px;\n        display: flex;\n    \n        @include breakpoint(phone) {\n            padding: 0;\n        }\n    \n        img {\n            width: 40px;\n            height: 56px;\n            border-radius: 8px;\n        }\n    \n        .list-pic1{\n            margin-right: 8px;\n        }\n    \n        .list-pic2{\n            margin-right: 8px;\n            position: relative;\n    \n            &::before{\n                content: '184';\n                color: var(--white);\n                font-size: 10px;\n                line-height: 15px;\n                font-weight: 600;\n                text-align: center;\n                position: absolute;\n                width: 26px;\n                height: 16px;\n                border-radius: 16px;\n                background-color: var(--orange);\n                top: -8px;\n                right: -6px;\n            }\n        }\n    \n        .list-pic3{\n            margin-right: 8px;\n            position: relative;\n    \n            &::before{\n                content: '2';\n                color: var(--white);\n                font-size: 10px;\n                line-height: 15px;\n                font-weight: 600;\n                text-align: center;\n                position: absolute;\n                width: 16px;\n                height: 16px;\n                border-radius: 16px;\n                background-color: var(--orange);\n                top: -8px;\n                right: -6px;\n            }\n        }\n    \n        .list2-pic1{\n            margin-right: 8px;\n            position: relative;\n    \n            &::before{\n                content: '16';\n                color: var(--white);\n                font-size: 10px;\n                line-height: 15px;\n                font-weight: 600;\n                text-align: center;\n                position: absolute;\n                width: 20px;\n                height: 16px;\n                border-radius: 16px;\n                background-color: var(--orange);\n                top: -8px;\n                right: -6px;\n            }\n        }\n    }\n}\n.delivery__back {\n    padding: 0 24px 0 24px;\n    display: flex;\n    align-items: center;\n    position: relative;\n\n    .back__about {\n        visibility: hidden;\n        position: absolute;\n        top: 28px;\n        left: 25%;\n        width: 288px;\n        height: 56px;\n        padding: 10px 16px 14px 16px;\n        border-radius: 8px;\n        background-color: var(--white);\n        box-shadow: 0 0 10px rgba(0, 0, 0, 0.15);\n    }\n\n    span {\n            position: relative;\n            width: 20px;\n            height: 20px;\n            top: 1px;\n            left: 1px;\n            margin-right: 10px;\n            border-radius: 50%;\n            background: linear-gradient(to left, var(--gradient-start), var(--gradient-end));\n\n            @include breakpoint(phone) {\n                width: 30px;\n            }\n\n        &::before {\n            content: '';\n            width: 16px;\n            height: 16px;\n            position: absolute;\n            top: 2px;\n            left: 2px;\n            border-radius: 50%;\n            background: var(--white);\n        }\n\n        &::after {\n            content: '';\n            left: 2px;\n            top: 2px;\n            position: absolute;\n            height: 15px;\n            width: 15px;\n            background-image: url('/src/assets/images/Tick.svg');\n            background-repeat: no-repeat;\n            background-position: 65% 50%;\n            \n        }\n    }\n\n    div {\n        font-weight: 400;\n        font-size: 13px;\n        line-height: 16px;\n        padding: 2px 0 0 0;\n\n        @include breakpoint(phone) {\n            line-height: 14px;\n        }\n\n        a {\n           color: var(--green);\n           border-bottom: 1px dashed var(--light-green);\n        \n           &:hover + .back__about {\n            visibility: visible;\n           }\n        }\n    }\n}\n.delivery__modal {\n    visibility: hidden;\n    position: fixed;\n    width: 400px;\n    height: 408px;\n    border-radius: 16px;\n    left: 40%;\n    top: 50%;\n    transform: translateY(-50%);\n    background-color: var(--white);\n    display: flex;\n    flex-direction: column;\n    justify-content: flex-start;\n    z-index: 3;\n\n    @include breakpoint(phone) {\n        position: fixed;\n        width: 100%;\n        height: 100%;\n        left: 0;\n    }\n\n    &-title {\n        display: flex;\n        justify-content: space-between;\n        padding: 16px 24px 13px 24px;\n        font-size: 20px;\n        font-weight: 700;\n        line-height: 28px;\n        letter-spacing: -0.20px;\n    }\n\n    &.modal__active{\n        visibility: visible;\n    }\n\n    &-cards {\n        display: flex;\n        flex-direction: column;\n        margin-bottom: 100px;\n    } \n    &-card {\n        display: flex;\n        padding: 0 22px 0 22px;\n        align-items: center;\n        margin-bottom: 16px;\n    }\n    &-card-input {\n        position: relative;\n        margin-right: 26px;\n        cursor: pointer;\n    \n    \n        &.active__system{\n            &::before {\n                content: '';\n                width: 16px;\n                height: 16px;\n                position: absolute;\n                left: 0;\n                top: -7px;\n                background-color: var(--magenta);\n                border-radius: 50%;\n                border: none;\n            }\n    \n            &::after {\n                content: '';\n                width: 8px;\n                height: 8px;\n                position: absolute;\n                left: 4px;\n                top: -3px;\n                background-color: var(--white);\n                border-radius: 50%;\n                border: none;\n            }\n        }\n    \n        &::before {\n            content: '';\n            width: 16px;\n            height: 16px;\n            position: absolute;\n            left: 0;\n            top: -7px;\n            background-color: transparent;\n            border-radius: 50%;\n            border: 1px solid var(--light-gray);\n        }\n        input {\n            display: none;\n        }\n    }\n    &-card-img {\n        margin-right: 5px;\n    }\n    &-card-number {\n        font-weight: 400;\n        font-size: 16px;\n        line-height: 24px;\n    }\n    &-btn1 {\n        padding: 16px 24px 24px 24px;\n        display: flex;\n        justify-content: left;\n    \n        @include breakpoint(phone) {\n            margin-top: 320px;\n            justify-content: center;\n        }\n    \n        button {\n            background-color: var(--magenta);\n            width: 164px;\n            height: 44px;\n            border-radius: 8px;\n            padding: 0 48px 5px 48px;\n            font-weight: 700;\n            font-size: 16px;\n            line-height: 24px;\n            align-items: center;\n            color: var(--white);\n    \n            @include breakpoint(phone){\n                width: 100%;\n            }\n        }\n    }\n}\n.modal__back {\n    display: none;\n    position: fixed;\n    left: 0;\n    top: 0;\n    z-index: 2;\n    width: 100vw;\n    height: 100vh;\n    background-color: rgba(5, 0, 10, 0.3);\n    user-select: none;\n\n    &.back__active {\n        display: block;\n    }\n}\n.modal__title {\n}\n.modal__button {\n    position: relative;\n    cursor: pointer;\n    width: 20px;\n    height: 20px;\n\n    &::before {\n        position: absolute;\n        content: '';\n        background-color: var(--gray);\n        right: 0;\n        top: 50%;\n        width: 18px;\n        height: 2px;\n        rotate: (45deg);\n    }\n    &::after {\n        position: absolute;\n        content: '';\n        background-color: var(--gray);\n        right: 0;\n        top: 50%;\n        width: 18px;\n        height: 2px;\n        rotate: (-45deg);\n    }\n}\n.modal__body {\n    display: flex;\n    flex-direction: column;\n}","@use '../util/' as *;\n\n.bucket__pay {\n    background-color: var(--white);\n    padding: 17px 24px 24px 24px;\n    border-radius: 16px;\n    margin-bottom: 16px;\n\n    @include breakpoint(tabphone) {\n        width: 100vw;\n        padding: 10px 16px 24px 16px;\n        margin-left: -16px;\n    }\n    \n    @include breakpoint(phone) {\n        max-width: 320px;\n        margin-left: -16px;\n        padding: 10px 16px 24px 16px;\n    }\n}\n.pay {\n    &__edit {\n        display: flex;\n        margin-bottom: 16px;\n        \n        @include breakpoint(phone) {\n            margin-bottom: 4px;\n        }\n    \n        h2 {\n            max-width: 755px;\n            width: 100%;\n            font-size: 24px;\n            font-weight: 700;\n            line-height: 32px;\n            letter-spacing: -1%;\n            margin-right: 10px;\n    \n            @include breakpoint(phone) {\n                font-size: 20px;\n                line-height: 34px;\n                letter-spacing: -0.20px;\n            }\n        }\n    \n        button {\n            padding: 7px 0 0 0;\n            width: 78px;\n            color: var(--magenta);\n            font-weight: 700;\n            font-size: 16px;\n            line-height: 24px;\n            text-align: right;\n            background: transparent;\n            cursor: pointer;\n    \n            @include breakpoint(phone) {\n                padding: 3px 0 0 0;\n            }\n        }\n    }\n    &__card {\n        display: flex;\n        margin-bottom: 8px;\n    \n        .card__system {\n            background-color: var(--smoky);\n            border-radius: 4px;\n            width: 32px;\n            height: 24px;\n            display: flex;\n            align-items: center;\n            justify-content: center;\n            margin-right: 8px;\n            \n            img {\n                width: 30px;\n                height: 9.33px;\n            }\n        }\n    \n        .card__number {\n            font-weight: 400;\n            font-size: 16px;\n            line-height: 26px;\n            margin-right: 12px;\n        }\n    \n        .card__date {\n            font-weight: 400;\n            font-size: 16px;\n            line-height: 26px;\n        }\n    }\n    \n    &__info {\n        color: var(--light-gray);\n        font-weight: 400;\n        font-size: 13px;\n        line-height: 14px;\n    }\n    \n    \n    &__modal {\n        visibility: hidden;\n        position: fixed;\n        left: 35%;\n        top: 25%;\n        background-color: var(--white);\n        width: 500px;\n        height: 408px;\n        border-radius: 16px;\n        display: flex;\n        flex-direction: column;\n        z-index: 3;\n    \n        @include breakpoint(phone) {\n            position: fixed;\n            width: 100%;\n            height: 100%;\n            left: 0;\n            top: 0;\n        }\n    \n        &.modal__active {\n            visibility: visible;\n        }\n    }\n\n    &__modal-buttons {\n        padding: 0 22px 0 22px;\n        margin-bottom: 24px;\n        display: flex;\n    }\n\n    &__modal-list {\n        padding: 0 22px 0 22px;\n        margin-bottom: 43px;\n    \n        @include breakpoint(phone) {\n            margin-bottom: 0px;\n        }\n    }\n    &__modal-title-item {\n        display: flex;\n        align-items: center;\n        margin-bottom: 16px;\n    }\n\n    &__modal-title-item-address {\n        flex: 1 1 auto;\n        max-width: 400px;\n        font-weight: 400px;\n        font-size: 16px;\n        line-height: 24px;\n    }\n    &__modal-title-item-bucket {\n    }\n}\n.delivery__modal-title {\n}\n.modal__title {\n}\n.modal__button {\n}\n.to-adress {\n    width: 224px;\n    height: 36px;\n    border-radius: 20px;\n    border: 2px solid rgba(203, 17, 171, 0.15);\n    padding: 0 0 2px 0;\n    background-color: var(--white);\n    color: var(--black);\n    margin-right: 20px;\n\n    &.border-active {\n        border: 2px solid var(--magenta);\n    }\n\n    @include breakpoint(phone) {\n       margin-right: 8px;\n       font-weight: 700;\n    }\n}\n.by-courier {\n    width: 224px;\n    height: 36px;\n    border-radius: 20px;\n    border: 2px solid rgba(203, 17, 171, 0.15);\n    padding: 0 0 2px 0;\n    background-color: var(--white);\n    color: var(--black);\n\n    &.border-active {\n        border: 2px solid var(--magenta);\n    }\n\n    @include breakpoint(phone) {\n        font-weight: 700;\n    }\n}\n.delivery__modal-card-input {\n}\n.delivery__modal-btn {\n}","@use '../util/' as *;\n\n.bucket__receiver {\n    background-color: var(--white);\n    padding: 17px 24px 24px 24px;\n    border-radius: 16px;\n    color: var(--light-gray);\n\n    @include breakpoint(tabphone) {\n        width: 100vw;\n        padding: 10px 16px 24px 16px;\n        margin-left: -16px;\n    }\n\n    @include breakpoint(phone) {\n        max-width: 320px;\n        margin-left: -16px;\n        padding: 10px 16px 24px 16px;\n        margin-bottom: 16px;\n    }\n\n    h2 {\n        max-width: 755px;\n        width: 100%;\n        font-size: 24px;\n        font-weight: 700;\n        line-height: 32px;\n        letter-spacing: -1%;\n        margin-right: 10px;\n        margin-bottom: 16px;\n        color: var(--black);\n\n        @include breakpoint(phone) {\n            font-size: 20px;\n            line-height: 30px;\n            letter-spacing: -0.20px;\n            margin-bottom: 5px;\n        }\n    }\n}\n.receiver__name {\n    max-width: 700px;\n    display: flex;\n    align-items: center;\n    margin-bottom: 1px;\n\n    @include breakpoint(tabphone) {\n        flex-direction: column;\n    }\n\n    @include breakpoint(phone) {\n        flex-direction: column;\n    }\n}\n.receiver__more {\n    max-width: 700px;\n    display: flex;\n    align-items: center;\n\n    @include breakpoint(tabphone) {\n        flex-direction: column;\n    }\n\n    @include breakpoint(phone) {\n        flex-direction: column;\n    }\n}\n.name {\n    &__name {\n        flex: 1 1 50%;\n        margin-right: 24px;\n    \n        @include breakpoint(tabphone) {\n            width: 100%;\n            margin: 0 0 10px 0;\n        }\n    \n        @include breakpoint(phone) {\n            width: 288px;\n            margin: 0 0 10px 0;\n        }\n    }\n    &__name-title {\n        font-weight: 400;\n        font-size: 13px;\n        line-height: 16px;\n        margin-bottom: 2px;\n        visibility: hidden;\n    \n        &.active-hat{\n            visibility: visible;\n        }\n    }\n    &__name-input {\n        width: 100%;\n        border-bottom: 2px solid var(--light-gray);\n        font-weight: 400;\n        font-size: 16px;\n        line-height: 24px;\n        margin-bottom: 4px;\n    \n        &.error {\n            color: red;\n        }\n    }\n    &__name-help {\n        font-weight: 400;\n        font-size: 12px;\n        line-height: 14px;\n        visibility: hidden;\n    \n        &.error {\n            color: red;\n            visibility: visible;\n        }\n    }\n    &__second {\n        flex: 1 1 50%;\n        width: 100%;\n    \n    \n        @include breakpoint(tabphone) {\n            width: 100%;\n        }\n    \n        @include breakpoint(phone) {\n            width: 288px;\n            margin-bottom: 9px;\n        }\n    }\n    &__second-title {\n        font-weight: 400;\n        font-size: 13px;\n        line-height: 16px;\n        margin-bottom: 2px;\n        visibility: hidden;\n    \n        &.active-hat{\n            visibility: visible;\n        }\n    }\n    &__second-input {\n        width: 100%;\n        border-bottom: 2px solid var(--light-gray);\n        font-weight: 400;\n        font-size: 16px;\n        line-height: 24px;\n        margin-bottom: 4px;\n        \n        &.error {\n            color: red;\n        }\n    }\n    &__second-help {\n        font-weight: 400;\n        font-size: 12px;\n        line-height: 14px;\n        visibility: hidden;\n    \n        &.error {\n            color: red;\n            visibility: visible;\n        }\n    }   \n}\n.receiver__more {\n}\n.more {\n    &__email {\n        flex: 1 1 33.3%;\n        margin-right: 24px;\n    \n    \n        @include breakpoint(tabphone) {\n            width: 100%;\n            margin: 0 0 8px 0;\n        }\n    \n        @include breakpoint(phone) {\n            width: 288px;\n            margin: 0 0 8px 0;\n        }\n    }\n    &__email-title {\n        font-weight: 400;\n        font-size: 13px;\n        line-height: 16px;\n        margin-bottom: 2px;\n        visibility: hidden;\n    \n        &.active-hat{\n            visibility: visible;\n        }\n    }\n    &-email {\n        font-weight: 400;\n        font-size: 16px;\n        line-height: 24px;\n        border-bottom: 2px solid var(--light-gray);\n        width: 100%;\n        margin-bottom: 7px;\n        \n        &.error {\n            color: red;\n        }\n    }\n    &__email-help {\n        font-weight: 400;\n        font-size: 12px;\n        line-height: 14px;\n        visibility: hidden;\n    \n        &.error {\n            color: red;\n            visibility: visible;\n        }\n    }\n    &__tel {\n        flex: 1 1 33.3%;\n        margin-right: 24px;\n    \n        &.error {\n            color: red;\n        }\n    \n        @include breakpoint(tabphone) {\n            width: 100%;\n            margin: 0 0 8px 0;\n        }\n    \n        @include breakpoint(phone) {\n            width: 288px;\n            margin: 0 0 6px 0;\n        }\n    }\n    &__tel-title {\n        font-weight: 400;\n        font-size: 13px;\n        line-height: 16px;\n        margin-bottom: 2px;\n        visibility: hidden;\n    \n        &.active-hat{\n            visibility: visible;\n        }\n    }\n    &-tel {\n        font-weight: 400;\n        font-size: 16px;\n        line-height: 24px;\n        border-bottom: 2px solid var(--light-gray);\n        width: 100%;\n        margin-bottom: 7px;\n    \n        &.error {\n            color: red;\n        }\n    \n        &::placeholder {\n            color: var(--black);\n        }\n    }\n    &__tel-help {\n        font-weight: 400;\n        font-size: 12px;\n        line-height: 14px;\n        visibility: hidden;\n    \n        &.error {\n            color: red;\n            visibility: visible;\n        }\n    }\n    &__number {\n        flex: 1 1 33.3%;\n    \n        &.error {\n            color: red;\n        }\n    \n        @include breakpoint(tabphone) {\n            width: 100%;\n        }\n    \n        @include breakpoint(phone) {\n            width: 288px;\n        }\n    }\n    &__number-title {\n        font-weight: 400;\n        font-size: 13px;\n        line-height: 16px;\n        margin-bottom: 2px;\n        visibility: hidden;\n    \n        &.active-hat{\n            visibility: visible;\n        }\n    }\n    &-number {\n        font-weight: 400;\n        font-size: 16px;\n        line-height: 24px;\n        border-bottom: 2px solid var(--light-gray);\n        width: 100%;\n        margin-bottom: 7px;\n    \n        @include breakpoint(phone) {\n            margin-bottom: 3px;\n        }\n    \n        &.error {\n            color: red;\n        }\n    }\n    &__number-help {\n        font-weight: 400;\n        font-size: 12px;\n        line-height: 14px;\n        visibility: hidden;\n    \n        &.error {\n            color: red;\n            visibility: visible;\n        }\n    }\n}","@use '../util/' as *;\n\n.main__bill {\n    \n}\n.bill__wrapper{\n    \n}\n.bill__info {\n    margin-bottom: 24px;\n}\n.info {\n    &__total {\n        display: flex;\n        font-weight: 700;\n        font-size: 24px;\n        line-height: 32px;\n        margin-bottom: 4px;\n    \n        @include breakpoint(phone) {\n            font-size: 20px;\n            line-height: 34px;\n            letter-spacing: -0.20px;\n            margin-bottom: 2px;\n        }\n    \n        h2 {\n            display: block;\n            flex: 1 1 auto;\n        }\n    }\n\n    &__pieces {\n        display: flex;\n        font-weight: 400;\n        font-size: 16px;\n        line-height: 24px;\n    \n        @include breakpoint(phone) {\n            margin-bottom: -2px;\n        }\n    \n        h2 {\n            display: block;\n            flex: 1 1 auto;\n        }\n    }\n\n    &__sale {\n        display: flex;\n        font-weight: 400;\n        font-size: 16px;\n        line-height: 28px;\n    \n        h2 {\n            display: block;\n            flex: 1 1 auto;\n        }\n    }\n\n    &__date {\n        color: var(--magenta);\n        font-size: 13px;\n        line-height: 16px;\n        margin-bottom: 13px;\n    \n        @include breakpoint(phone) {\n            display: none;\n        }\n    }\n    &__back {\n            padding: 8px 8px 12px 8px;\n            display: flex;\n            background-color: var(--smoky);\n            border-radius: 8px;\n            margin-bottom: 28px;\n            position: relative;\n    \n            @include breakpoint(phone) {\n                background-color: var(--smoky-dark);\n                margin-bottom: -5px;\n            }\n            \n            span {\n                    position: relative;\n                    width: 22px;\n                    height: 20px;\n                    top: 7px;\n                    left: 0px;\n                    margin-right: 10px;\n                    border-radius: 50%;\n                    // background: linear-gradient(to left, var(--gradient-start), var(--gradient-end));\n        \n                    @include breakpoint(phone) {\n                        margin-right: 15px;\n                    }\n                    \n                &::before {\n                    content: '';\n                    width: 20px;\n                    height: 20px;\n                    position: absolute;\n                    top: 2px;\n                    left: 2px;\n                    border-radius: 50%;\n                    background: var(--white);\n                    border: 2px solid var(--gradient-start);\n                }\n        \n                &::after {\n                    content: '';\n                    left: 3px;\n                    top: 4px;\n                    position: absolute;\n                    height: 15px;\n                    width: 15px;\n                    background-image: url('/src/assets/images/Tick.svg');\n                    background-repeat: no-repeat;\n                    background-position: 65% 50%;\n                    \n                }\n            }\n        \n            .back__about {\n                visibility: hidden;\n                position: absolute;\n                top: 48px;\n                left: 5%;\n                width: 288px;\n                height: 56px;\n                padding: 10px 16px 14px 16px;\n                border-radius: 8px;\n                background-color: var(--white);\n                box-shadow: 0 0 10px rgba(0, 0, 0, 0.15);\n            }\n    \n            div {\n                font-weight: 400;\n                font-size: 13px;\n                line-height: 16px;\n                padding: 2px 0 0 0;\n        \n                a {\n                   color: var(--green);\n                   border-bottom: 1px dashed var(--light-green); \n    \n                   &:hover + .back__about {\n                    visibility: visible;\n                   }\n                }\n    \n            }\n    }\n    &__credit {\n    }\n\n    &__delivery {\n        display: flex;\n        font-weight: 400;\n        font-size: 16px;\n        line-height: 24px;\n        margin-bottom: 24px;\n    \n        @include breakpoint(phone) {\n            margin-top: -2px;\n            margin-bottom: 14px;\n        }\n    \n        h2 {\n            display: block;\n            flex: 1 1 auto;\n        }\n    }\n    &__place {\n    }\n}\n\n.total {\n    &__value {\n        margin-right: 3px;\n        letter-spacing: 1%;\n    \n        @include breakpoint(phone) {\n            font-size: 20px;\n            line-height: 34px;\n            letter-spacing: -0.05px;\n        }\n    }\n    &__currency {\n        font-size: 20px;\n        line-height: 36px;\n    }\n}\n.pieces {\n    &__value {\n        margin-right: 3px;\n    }\n    &__currency {\n    }\n}\n.sale {\n}\n.sale__value {\n    margin-right: 3px;\n}\n.sale__currency {\n}\n.place {\n    &__edit {\n        display: flex;\n        justify-content: space-between;\n        margin-bottom: 8px;\n    \n        @include breakpoint(phone) {\n            display: none;\n        }\n    }\n    &__edit2 {\n        display: flex;\n        justify-content: space-between;\n    \n        @include breakpoint(phone) {\n            display: none;\n        }\n    }\n    &__title {\n        font-weight: 700;\n        font-size: 16px;\n        line-height: 16px;\n    }\n    &__button {\n        width: 16px;\n        height: 16px;\n        background-image: url(/src/assets/images/edit.svg);background-color: transparent;\n    }\n    &__address {\n        font-weight: 400;\n        font-size: 13px;\n        line-height: 16px;\n        margin-bottom: 4px;\n    \n        @include breakpoint(phone) {\n            display: none;\n        }\n    }\n}\n.credit {\n}\n.pay__system1 {\n    margin-top: 10px;\n    display: flex;\n    font-size: 13px;\n    align-items: center;\n    margin-bottom: 10px;\n}\n.card__system {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    background-color: var(--smoky);\n    width: 32px;\n    height: 24px;\n    border-radius: 4px;\n    margin-right: 9px;\n\n    @include breakpoint(phone) {\n        display: none;\n    }\n}\n.pay__number {\n    font-weight: 400;\n    font-size: 13px;\n    line-height: 22px;\n    text-align: right;\n\n    @include breakpoint(phone) {\n        display: none;\n    }\n}\n.info__instant {\n    background-color: var(--smoky);\n    border-radius: 8px;\n    padding: 8px 8px 12px 8px;\n\n    @include breakpoint(phone) {\n        background-color: var(--smoky-dark);\n    }\n\n    p {\n        font-weight: 400;\n        font-size: 13px;\n        line-height: 16px;\n    }\n}\n.instant {\n}\n.instant__input {\n    display: flex;\n    margin-bottom: 8px;\n    cursor: pointer;\n\n    input {\n        display: none;\n    }\n\n    p {\n        font-weight: 400;\n        font-size: 13px;\n        line-height: 22px;\n    }\n}\n.input__checkbox {\n    position: relative;\n    width: 22px;\n    height: 22px;\n    margin-right: 8px;\n\n    &.instant__pay {\n        &::before {\n            content: '';\n            position: absolute;\n            width: 22px;\n            height: 22px;\n            background-color: var(--magenta);\n            border: none;\n            left: 0;\n            top: 0;\n            border-radius: 6px;\n            background-image: url('/src/assets/images/Input.svg');\n            background-repeat: no-repeat;\n            background-position: 50% 50%;\n        }\n    }\n\n    &::before {\n        content: '';\n        position: absolute;\n        width: 22px;\n        height: 22px;\n        background-color: var(--smoky);\n        border: 1px solid var(--light-gray);\n        left: 0;\n        top: 0;\n        border-radius: 6px;\n    }\n}\n.bill__button {\n    background-color: var(--magenta);\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    height: 44px;\n    border-radius: 8px;\n    padding: 0 32px 5px 32px;\n    margin-bottom: 10px;\n    cursor: pointer;\n\n    @include breakpoint(phone) {\n        margin-bottom: 14px;\n    }\n\n    button {\n        font-size: 16px;\n        width: 100%;\n        height: 100%;\n        font-weight: 700;\n        text-align: center;\n        line-height: 24px;\n        background-color: transparent;\n        color: var(--white);\n    }\n    \n}\n.button {\n}\n.bill__rules {\n    display: flex;\n    align-items: flex-start;\n    font-size: 13px;\n    line-height: 16px;\n    font-weight: 400;\n\n    p {\n        font-weight: 400;\n        font-size: 13px;\n        line-height: 16px;\n    }\n\n    a {\n        color: var(--black);\n        position: relative;\n        border-bottom: 1px solid var(--rulers);\n    }\n}\n.rules {\n}\n.rules__checkbox {\n    width: 13px;\n    height: 24px;\n    position: relative;\n    margin-right: 10px;\n\n    input {\n        display: none;\n    }\n\n    &::before {\n        content: '';\n        position: absolute;\n        width: 12.51px;\n        height: 10.16px;\n        top: 3.32px;\n        left: 0.26px;\n        background-image: url(/src/assets/images/black_tick.svg);\n        background-repeat: no-repeat;\n    }\n}","@use '../util/' as *;\n\n.footer{\n    height: 88px;\n    width: 100%;\n    background-color: var(--violet)\n}\n.footer__back{\n    background-color: var(--smoky);\n    width: 100%;\n    height: 45px;\n    border-radius: 0 0 24px 24px;\n}\n.footer__rights{\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    font-weight: 400;\n    font-size: 13px;\n    height: 100%;\n    line-height: 16px;\n    text-align: center;\n    color: var(--light-white);\n    letter-spacing: 1%;\n\n    @include breakpoint(phone) {\n       padding: 40px 0 90px 0;\n    }\n}\n\n",":root {\n    --violet: rgba(103, 37, 168, 1);\n    --white: rgba(255, 255, 255, 1);\n    --search-bar: rgba(255, 255, 255, 0.2);\n    --search-bar-hover: rgba(255, 255, 255, 0.5);\n    --black: rgba(0, 0, 0, 1);\n    --magenta: rgba(203, 17, 171, 1);\n    --gray: rgba(151, 151, 175, 1);\n    --light-gray: rgba(160, 160, 164, 1);\n    --rulers: rgba(0, 0, 0, 0.2);\n    --coral: rgba(255, 59, 48, 1);\n    --green: rgba(12, 180, 119, 1);\n    --light-green: rgba(12, 180, 119, 0.2);\n    --gradient-start: rgba(12, 211, 139, 1);\n    --gradient-end: rgba(12, 180, 119, 1);\n    --smoky: rgba(246, 246, 250, 1);\n    --smoky-dark: rgba(240, 236, 244, 1);\n    --orange: rgba(245, 81, 35, 1);\n    --deep-orange: rgba(255, 151, 13, 1);\n    --light-white: rgba(255, 255, 255, 0.7)\n}","@use '../util' as *;\n\nbody {\n    background: var(--violet);\n    font-family: var(--font-segoe);\n    display: flex;\n    flex-direction: column;\n    position: relative;\n    \n    &.overflow{\n        overflow-y: hidden;\n    }\n\n    &::after {\n        content: '';\n        position: absolute;\n        top: 89px;\n        left: 0;\n        border-radius: 25px 25px 0 0;\n        background-color: var(--smoky);\n        width: 100%;\n        height: 24px;\n\n        @include breakpoint(phone) {\n            display: none;\n        }\n    }\n}\n\n.container {\n    max-width: 1400px;\n    margin: 0 auto;\n    overflow: hidden;\n}\n\nheader {\n    width: 100%;\n}\n\nmain {\n    width: 100%;\n    min-height: 1825px;\n    margin: 1 1 auto;\n\n    @include breakpoint(tabphone) {\n        min-height: 2950.33px;\n    }\n\n    @include breakpoint(phone) {\n        min-height: 2717.33px;\n    }\n}\n\nfooter {\n    width: 100%;\n    height: 100%;\n\n    @include breakpoint(phone) {\n        min-height: 88px;\n    }\n}\n\n\n.mobile__nav {\n    display: none;\n    position: fixed;\n    left: 0;\n    bottom: 0;\n    background-color: var(--white);\n    width: 320px;\n    height: 56px;\n    padding: 0 13px 0 13px;\n    z-index: 10;\n\n    img {\n        width: 28px;\n        height: 28px;\n\n        @include breakpoint(tablet) {\n            margin-right: 120px;\n\n            &:last-child {\n                margin-right: 0;\n            }\n        }\n\n        @include breakpoint(tabphone) {\n            margin-right: 45px;\n\n            &:last-child {\n                margin-right: 0;\n            }\n        }\n\n        @include breakpoint(phone) {\n            margin-right: 38.5px;\n\n            &:last-child {\n                margin-right: 0;\n            }\n        }\n    }\n\n    @include breakpoint(tablet) {\n        display: flex;\n        align-items: center;\n        justify-content: center;\n        max-width: 996px;\n        width: 100%;\n        padding: 0 70px 0 70px;\n    }\n\n    @include breakpoint(phone) {\n        display: flex;\n        align-items: center;\n        justify-content: left;\n        width: 320px;\n        padding: 0 13px 0 13px;\n    }\n}\n\n",":root {\n    --font-segoe: 'Segoe UI', sans-serif;\n}\n\n\n@font-face {\n\tfont-family: 'Segoe UI';\n\tsrc: url('../../assets/fonts/SegoeUI-SemiBold.eot');\n\tsrc: local('Segoe UI Semibold'), local('SegoeUI-SemiBold'),\n\t\turl('../../assets/fonts/SegoeUI-SemiBold.eot?#iefix') format('embedded-opentype'),\n\t\turl('../../assets/fonts/SegoeUI-SemiBold.woff') format('woff'),\n\t\turl('../../assets/fonts/SegoeUI-SemiBold.ttf') format('truetype');\n\tfont-weight: 600;\n\tfont-style: normal;\n}\n\n@font-face {\n\tfont-family: 'Segoe UI';\n\tsrc: url('../../assets/fonts/SegoeUI.eot');\n\tsrc: local('Segoe UI'), local('SegoeUI'),\n\t\turl('../../assets/fonts/SegoeUI.eot?#iefix') format('embedded-opentype'),\n\t\turl('../../assets/fonts/SegoeUI.woff') format('woff'),\n\t\turl('../../assets/fonts/SegoeUI.ttf') format('truetype');\n\tfont-weight: 400;\n\tfont-style: normal;\n}\n\n@font-face {\n\tfont-family: 'Segoe UI';\n\tsrc: url('../../assets/fonts/SegoeUI-Bold.eot');\n\tsrc: local('Segoe UI Bold'), local('SegoeUI-Bold'),\n\t\turl('../../assets/fonts/SegoeUI-Bold.eot?#iefix') format('embedded-opentype'),\n\t\turl('../../assets/fonts/SegoeUI-Bold.woff') format('woff'),\n\t\turl('../../assets/fonts/SegoeUI-Bold.ttf') format('truetype');\n\tfont-weight: 700;\n\tfont-style: normal;\n}\n"],"sourceRoot":""}]);
// Exports
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/app/js/index.js");
/******/ 	
/******/ })()
;
//# sourceMappingURL=index.6d0040967c8534fa26d0.js.map